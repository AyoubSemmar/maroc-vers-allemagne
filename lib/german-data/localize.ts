...
const OVERLAYS: Record<string, Partial<Record<AppLocale, LevelOverlay>>> = {
  a1: { fr: a1_fr as LevelOverlay, en: a1_en as LevelOverlay, de: a1_de as LevelOverlay, es: a1_es as LevelOverlay },
  a2: { fr: a2_fr as LevelOverlay, en: a2_en as LevelOverlay, de: a2_de as LevelOverlay, es: a2_es as LevelOverlay },
  b1: { fr: b1_fr as LevelOverlay, en: b1_en as LevelOverlay, de: b1_de as LevelOverlay, es: b1_es as LevelOverlay },
  b2: { fr: b2_fr as LevelOverlay, en: b2_en as LevelOverlay, de: b2_de as LevelOverlay, es: b2_es as LevelOverlay },
  c1: { fr: c1_fr as LevelOverlay, en: c1_en as LevelOverlay, de: c1_de as LevelOverlay, es: c1_es as LevelOverlay },
}
