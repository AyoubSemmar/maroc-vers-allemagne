  ...
  lessons: [
    {
      ...
      grammar: {
        ...
        content: `حين تريد أن تتحدث عن أمرٍ لم يحدث في الماضي، وتتخيل ما كان يمكن أن يحدث لو تغيّر شرط ما، فأنت بحاجة إلى صيغة غير موجودة في زمن ألماني عادي — لأن Präteritum وPerfekt يصفان ما وقع فعلاً، لا ما كان مفترضاً أن يقع. هذه الفجوة يسدّها Konjunktiv II der Vergangenheit، وهو الأداة التي يستخدمها الألمان للتعبير عن الأسف، اللوم، النصيحة المتأخرة، والشرط غير الحقيقي في الماضي — أي كل ما هو "لو كان الأمر كذا، لكان كذا" بعد فوات الأوان.

المنطق الزمني هنا مهم جداً ويختلف عن Konjunktiv II العادي (Präsens): إذا قلت Wenn ich Zeit hätte, würde ich kommen فأنت تتحدث عن احتمال لا يزال مفتوحاً في الحاضر أو المستقبل. أما Wenn ich Zeit gehabt hätte, wäre ich gekommen فيغلق الباب نهائياً: الوقت انتهى، والفرصة ضاعت، ولا مجال لتغيير النتيجة الآن. هذا الفارق بين "لا يزال ممكناً" و"فات أوانه" هو جوهر ما يميّز صيغة الماضي هنا عن نظيرتها في الحاضر.

من الناحية التركيبية، الصيغة تُبنى دائماً من فعل مساعد في Konjunktiv II زائد Partizip II: hätte مع معظم الأفعال، وwäre مع أفعال الحركة والتغيّر (مثل gehen، kommen، werden) وأفعال sein وbleiben. فكرياً، هي ببساطة Plusquamperfekt (hatte/war + Partizip II) لكن الفعل المساعد يتحوّل إلى صيغته الافتراضية hätte/wäre بدل hatte/war.

الحالة الخاصة والأكثر صعوبة هي وجود فعل مودالي في الجملة: هنا لا نقول hätte gemusst بل نستخدم ما يُعرف بـ Doppelinfinitiv، حيث يبقى الفعل المودالي في صورة المصدر في نهاية الجملة: Ich hätte früher kommen sollen (كان يجب أن آتي مبكراً ولم أفعل). لاحظ أن ترتيب الكلمات يتغير أيضاً: hätte يذهب إلى موضعه الثاني المعتاد بينما ينتقل الفعلان (Infinitiv + Modalverb) معاً إلى آخر الجملة الفرعية أو الرئيسية.

هذا يقودنا إلى الخطأ الأكثر شيوعاً عند المتعلمين المتقدمين: الخلط بين hätte kommen sollen (تعبير عن ندم على فعل ماضٍ لم يُنجَز) وsollte kommen (نصيحة أو التزام حالي/مستقبلي لم يُحدَّد مصيره بعد). الجملة الأولى تخبرنا بوضوح أن الشخص لم يأتِ ويأسف على ذلك؛ الثانية لا تحمل هذا الحسم الزمني إطلاقاً. الخطأ الثاني الشائع هو محاولة استخدام würde + Infinitiv II (würde gekommen sein) بدل الصيغة الأبسط والأصح hätte/wäre + Partizip II، وهو استخدام نادر وغير طبيعي في الكتابة والحديث الفصيح.`,
        tables: [
          {
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `في العربية، تصريف الاسم لا يغيّر شكله بحسب موقعه في الجملة بالطريقة التي تفعلها الألمانية عبر حالات Nominativ وAkkusativ وDativ وGenitiv؛ عادةً يكفي أن تتغيّر أداة التعريف (der، den، dem، des) بينما يبقى جسم الاسم نفسه ثابتاً. لكن توجد في الألمانية مجموعة خاصة من الأسماء المذكرة تخرج عن هذه القاعدة: فهي لا تكتفي بتغيير الأداة، بل يتغيّر الاسم نفسه أيضاً بإضافة -n أو -en في كل الحالات ما عدا Nominativ المفرد. هذه المجموعة تُعرف بـ n-Deklination أو "الأسماء الضعيفة" (schwache Substantive)، وهي ظاهرة تُربك حتى المتحدثين الأجانب المتقدمين لأنها غير متوقَّعة قياساً على بقية الأسماء المذكرة.

من أين تأتي هذه الأسماء؟ أغلبها ينتمي إلى فئات يمكن التعرّف عليها: أسماء أشخاص ومهن منتهية غالباً بـ -e (der Kollege، der Junge، der Nachbar)، أسماء حيوانات (der Löwe، der Bär، der Affe)، جنسيات (der Türke، der Franzose)، وكذلك كلمات أصلها لاتيني أو يوناني تنتهي بلاحقات مثل -ist أو -ent أو -ant أو -at (der Student، der Präsident، der Journalist، der Demokrat). معرفة هذه الأنماط الصرفية تساعدك على توقّع أي اسم جديد سيسلك هذا المسلك دون الحاجة لحفظه فردياً.

القاعدة العملية بسيطة بمجرد فهمها: Nominativ المفرد يبقى بلا نهاية إضافية (der Student)، لكن Akkusativ وDativ وGenitiv المفرد تأخذ جميعها -en (den/dem/des Studenten). في صيغة الجمع، تسلك هذه الأسماء عموماً السلوك المعتاد لأسماء الجمع بـ -en في كل الحالات، فلا فرق يُذكر هناك. توجد حالتان شاذّتان تستحقان انتباهاً خاصاً: der Herr يأخذ -n فقط في المفرد (den Herrn) لكن -en في الجمع (die Herren)؛ وder Name ينضم إلى هذه المجموعة لكنه يضيف أيضاً -s في حالة Genitiv المفرد (des Namens) بدل الاكتفاء بـ -n وحدها، وهو استثناء يشترك فيه مع كلمات مشابهة مثل der Gedanke وder Glaube.

الخطأ الأكثر شيوعاً بين متعلمي المستوى المتقدم هو التوقف عند تصريف الأداة فقط وترك جسم الاسم دون تغيير، فيُكتب بالخطأ Ich sehe den Student أو Ich helfe dem Nachbar، بينما الصحيح Ich sehe den Studenten وIch helfe dem Nachbarn. تذكّر أن نسيان النهاية -n/-en على الاسم نفسه هو أول ما يلفت انتباه المصحّح في اختبار Goethe C1، لأنه يكشف عدم استيعاب كون الصفة "الضعيفة" في هذه الأسماء متعلقة بالاسم لا بالأداة وحدها.`,
        tables: [
          {
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `الصيغة المباشرة للمبني للمجهول werden + Partizip II ليست خاطئة أبداً في C1، لكن تكرارها بكثرة يجعل الأسلوب مرهقاً وغير احترافي، خصوصاً في الكتابة الأكاديمية والتقارير الرسمية وسياقات الأعمال. لهذا طوّرت الألمانية المكتوبة والراقية مجموعة من البدائل الأسلوبية (Passiversatzformen) التي تؤدي المعنى نفسه، لا سيما معنى "الإمكانية" (يمكن أن يُفعَل) أو "الضرورة" (يجب أن يُفعَل)، لكن بصياغة أكثر إيجازاً وأناقة. إتقان هذه البدائل هو أحد أوضح علامات النضج اللغوي عند متعلم الألمانية.

أول بديل وأكثرها مرونة هو sich lassen + Infinitiv، ويقابل دائماً معنى passiv + können: Das Problem lässt sich lösen تعني حرفياً "المشكلة تدع نفسها تُحَل"، أي يمكن حلها. ثانياً، sein + zu + Infinitiv يحمل معنيين محتملين بحسب السياق — الإمكانية أو الضرورة — Die Aufgabe ist zu lösen قد تعني يمكن حلها أو يجب حلها، والسياق وحده يحدد أيهما. ثالثاً، لاحقات صفاتية مثل -bar و-lich تحوّل الفعل مباشرة إلى صفة تحمل معنى الإمكانية السلبية: lösbar (قابل للحل)، essbar (صالح للأكل)، verständlich (مفهوم) — وهي أقصر البدائل وأكثرها استخداماً في الكتابة العلمية والتقنية. رابعاً، man + فعل فاعل هو الحل الأبسط والأكثر شفوية، يحوّل الجملة بالكامل من مبني للمجهول إلى مبني للمعلوم بفاعل عام غير محدد. وأخيراً، هناك ما يُعرف بـ Rezipientenpassiv عبر bekommen/kriegen + Partizip II، وهو تركيب خاص يُبرز المتلقي بدل الفاعل: Ich bekomme das Paket geschickt تعني الطرد يُرسَل إليّ، وتصلح فقط مع أفعال لها مفعول به غير مباشر (Dativobjekt) كأصل الجملة الفاعلة.

الفرق الجوهري بين هذه البدائل هو درجة الرسمية والدقة الدلالية: -bar وsich lassen يقتصران عادة على معنى الإمكانية وحدها، بينما sein + zu قد يحمل أيضاً معنى الإلزام، وman هو الأقل رسمية بينها جميعاً. في العربية لا يوجد مقابل صرفي مباشر لهذا التنوع؛ نحن نعتمد غالباً على تراكيب مثل "قابل لـ" أو "يمكن" بصيغة واحدة، لذا يحتاج المتعلم إلى تدريب الأذن على اختيار البديل الألماني الأنسب للسجل اللغوي بدل الترجمة الحرفية.

الخطأ الشائع عند المتقدمين هو استخدام -bar مع أفعال لا تقبلها صرفياً، أو الخلط بين sich lassen (تتطلب دائماً فاعلاً هو الشيء نفسه الذي يُفعل به الفعل، لا فاعلاً بشرياً) وsein + zu، فيُكتب بالخطأ Er lässt sich einladen بمعنى "يمكن دعوته" بينما يقصد المتعلم شيئاً آخر تماماً — فالجملة هنا تعني أن الشخص نفسه يسمح بدعوته، وهو معنى مختلف قليلاً عن الإمكانية الموضوعية الصرفة التي يوحي بها السياق الأصلي.`,
        tables: [
          {
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `الجملة الشرطية العادية في الألمانية تبدأ بأداة الربط wenn، لكن في السجل الرسمي والأدبي والصحفي، يمكن الاستغناء عن wenn تماماً وصياغة الشرط عبر إجراء نحوي وحيد: تقديم الفعل المُصرَّف إلى بداية الجملة الفرعية، تماماً كما يحدث في أسئلة نعم/لا. فبدل Wenn du Zeit hast, komm vorbei تصبح الجملة Hast du Zeit, komm vorbei. هذا التركيب لا يغيّر المعنى إطلاقاً، إنما يرفع درجة الرسمية والأناقة الأسلوبية، وهو من العلامات المميزة لأسلوب C1 المتقدم في الكتابة.

آلية هذا التركيب تعتمد كلياً على ترتيب الكلمات لا على أداة جديدة: بما أن wenn أداة ربط تدفع الفعل إلى نهاية الجملة الفرعية، فإن حذفها يترك فراغاً يُملأ بنقل الفعل المُصرَّف (أو الفعل المساعد) إلى الموضع الأول مباشرة، فتصبح بنية الجملة الفرعية مطابقة شكلياً لسؤال نعم/لا معزول، لكن السياق والفاصلة وما يتبعها من جملة رئيسية يوضّحان أنها ليست سؤالاً بل شرطاً. هذا الأسلوب يعمل في كل الأزمنة: في المضارع (Hat er Geld, kauft er es)، في الشرط الافتراضي بصيغة Konjunktiv II (Wäre ich du, würde ich bleiben)، وفي الشرط غير الحقيقي الماضي الذي يجمع بين هذا الترتيب وKonjunktiv II der Vergangenheit (Wäre er früher gekommen, hätte er sie getroffen).

من الناحية الأسلوبية، تبدأ الجملة الرئيسية أحياناً بأداة so اختيارية وظيفتها الإشارة بوضوح إلى أن ما قبلها كان شرطاً وليس سؤالاً مستقلاً (Hilft er mir, so helfe ich ihm)؛ هذا الاستخدام أقرب إلى الأدب الكلاسيكي والنصوص الرسمية جداً، بينما في الصحافة والمراسلات الرسمية الحديثة يُستغنى عنها غالباً وتكتفي الفاصلة بالفصل بين الشرط والنتيجة. من أكثر الصيغ انتشاراً في هذا القالب صيغة Sollten Sie + Infinitiv، الشائعة جداً في رسائل الشركات والإعلانات الرسمية: Sollten Sie Fragen haben, kontaktieren Sie uns — وهي بديل مهذّب ورسمي لـ Wenn Sie Fragen haben sollten.

بالمقارنة مع ما تعرفه من قبل في B1/B2، حيث كانت wenn هي الخيار شبه الوحيد لصياغة الشرط، هذا التركيب لا يُستخدم في الحديث اليومي إطلاقاً — استخدامه في محادثة عادية يبدو متكلَّفاً وغريباً؛ مجاله الطبيعي هو النصوص المكتوبة الرسمية والأدبية والقانونية. الخطأ الشائع عند المتعلمين المتقدمين هو محاولة استخدام هذا الترتيب في كلام شفوي عفوي، أو نسيان أن الفعل الذي يُقدَّم يجب أن يكون الفعل المُصرَّف (الفعل المساعد إن وُجد) لا الفعل الرئيسي، فتُكتب بالخطأ جملة تُقدّم فيها Partizip II بدل hätte/wäre المساعد.`,
        tables: [
          {
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `الـ Funktionsverbgefüge (وتُختصر FVG) هي تركيبة ثابتة من فعل ووظيفي (Funktionsverb) مع اسم مجرد، غالباً مشتق من فعل، بحيث يفقد الفعل معناه المعجمي الأصلي ويتحول إلى مجرد حامل للزمن والصيغة والشخص، بينما يحمل الاسم المعنى الحقيقي للعبارة كلها. بعبارة أخرى: الوحدة الدلالية لم تعد الفعل وحده، بل الفعل والاسم معاً كوحدة واحدة تُترجم غالباً بفعل بسيط واحد في العربية أو حتى بفعل ألماني بسيط مرادف موجود أصلاً في اللغة، مثل treffen eine Entscheidung مقابل entscheiden ببساطة.

السبب في وجود هذا التركيب وانتشاره الواسع في الألمانية الرسمية والإدارية والصحفية والقانونية والأكاديمية هو أنه يمنح الكاتب مرونة تعبيرية أكبر مما يتيحه الفعل البسيط: يمكن إضافة صفات إلى الاسم (eine wichtige Entscheidung treffen)، ويمكن تحويله بسهولة إلى جملة اسمية أو إلى Passiv (eine Entscheidung wurde getroffen)، كما يعطي جرساً أكثر رسمية وموضوعية يناسب سجل الكتابة الإدارية والصحفية. لذلك فإن إتقانها علامة واضحة على بلوغ مستوى C1، إذ يميّز المتحدث الأصلي بين النص العامي البسيط والنص الرسمي المصقول.

من الناحية الميكانيكية، لا يمكن التنبؤ منطقياً بأي فعل وظيفي يُستخدم مع أي اسم؛ فالأمر أشبه بمتلازمات لفظية (collocations) يجب حفظها كوحدات جاهزة: treffen مع Entscheidung وMaßnahmen، وbringen مع zum Ausdruck وzur Sprache، وnehmen مع Rücksicht وBezug، وstellen مع Antrag وFrage، وkommen مع in Frage، وstehen مع zur Verfügung. كثير من هذه التراكيب يرافقها حرف جر ثابت لا يتغير، وأحياناً يظهر الاسم بلا Artikel كما في in Frage kommen أو zur Verfügung stehen، وهذا يخالف قاعدة الأسماء التي تعلمها الدارس في B1/B2 حيث يرافق الاسم غالباً أداة تعريف أو تنكير.

الخطأ الشائع جداً عند المتعلمين المتقدمين هو محاولة بناء FVG جديدة بالقياس المنطقي، فيقولون مثلاً machen eine Entscheidung بدل treffen eine Entscheidung، أو ينسون حرف الجر الثابت المرافق كما في nehmen Rücksicht بدون auf، أو يضيفون أداة تعريف حيث لا ينبغي ذلك مثل in die Frage kommen بدل in Frage kommen. الحل الوحيد هو حفظ كل FVG كوحدة كاملة بحرف جرها وحالتها الإعرابية، تماماً كما تُحفظ التعبيرات الاصطلاحية، وليس بتفكيكها إلى فعل واسم منفصلين.`,
        tables: [
          {
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `الاشتقاق الاسمي الموسع، أو Partizipialattribut ممتد، هو أسلوب يُحوّل جملة وصل كاملة (Relativsatz) إلى صفة واحدة موسّعة تسبق الاسم مباشرة، بدل أن تتبعه في جملة منفصلة. فبدل أن نكتب der Mann, der seit Jahren in Berlin lebt نكتب der seit Jahren in Berlin lebende Mann، حيث تُضغط الجملة الوصلية بأكملها — الفاعل الضمني والظرف الزمني والفعل — في سلسلة واحدة من الكلمات تقع بين أداة التعريف والاسم، وتنتهي هذه السلسلة دائماً بصيغة الفاعل أو المفعول (Partizip I أو II) الذي يأخذ نهاية الصفة العادية حسب الجنس والحالة والعدد.

هذا الأسلوب هو السمة الأبرز للغة الصحافة الألمانية الجادة (مثل Zeit وFAZ وSpiegel) وللنصوص الأكاديمية والقانونية، لأنه يسمح بحشو معلومات كثيفة داخل جملة واحدة موجزة دون تكرار الفاعل أو اللجوء إلى جمل فرعية متتالية تُثقل النص. القارئ الأصلي يستخرج المعلومة المضغوطة تلقائياً، لكنها تمثل عقبة حقيقية أمام متعلم اللغة لأنه يجب أن يقرأ السلسلة كاملة قبل أن يصل إلى الاسم الذي تصفه، بعكس العربية التي تضع الصفة أو الجملة الوصفية غالباً بعد الموصوف مباشرة لا قبله.

من الناحية الميكانيكية يجب أولاً التمييز بين نوعي الصيغة: Partizip I (فعل + -end) يُعبّر عن حدث متزامن أو مستمر وله معنى فاعل نشط، فـ der lesende Student تعني الطالب الذي يقرأ الآن (فعل ناقص/مستمر). أما Partizip II (صيغة الماضي التام المألوفة) فتُعبّر عن حدث مكتمل أو معنى مبني للمجهول، فـ das geöffnete Fenster تعني النافذة التي فُتحت (نتيجة فعل انتهى). وعند التحويل من جملة وصل مبنية للمجهول (اسم + Passiv) يُستخدم دائماً Partizip II وليس Partizip I، وهذا أحد أدق فروق المعنى في هذا الباب.

أما التوسيع نفسه فيعني أن أي عنصر كان سيقع داخل الجملة الوصلية الأصلية — ظرف زمان أو مكان، أو شبه جملة جر، أو حتى فاعل مضاف — يُدفع الآن إلى ما قبل صيغة الفاعل/المفعول مباشرة، فتتكون سلسلة نحوية طويلة يجب على القارئ الاحتفاظ بها في الذهن حتى يظهر الاسم في النهاية ويكتمل المعنى: das gestern vom Parlament verabschiedete Gesetz. الخطأ الشائع عند المتعلمين هو نسيان تصريف نهاية الصفة في الاشتقاق نفسه حسب حالة الاسم وجنسه، أو محاولة اشتقاق هذا التركيب من أفعال لا تقبله بسهولة، أو الخلط بين Partizip I وII فينتج معنى معكوساً تماماً عما قُصد.`,
        tables: [
          {
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `اللغة الأكاديمية والعلمية في الألمانية (wissenschaftliche Sprache) ليست مجرد مفردات أثقل، بل نظام كامل من الاختيارات الأسلوبية يهدف إلى نزع الذاتية عن النص وإعطائه طابعاً موضوعياً قابلاً للتحقق، وهذا ما يميزها جذرياً عن اللغة المحكية أو حتى الكتابة الرسمية في B2. أول قاعدة وأهمها هي تجنب ضمير المتكلم ich قدر الإمكان، لأن العلم يُفترض أنه لا يعتمد على رأي شخص بعينه بل على ملاحظة أو نتيجة يمكن لأي باحث الوصول إليها؛ لذلك يُستبدل ich habe untersucht بصيغة المبني للمجهول es wurde untersucht، أو بصيغة man، أو بتعبيرات غير شخصية جاهزة مثل es lässt sich feststellen وes ist davon auszugehen، وهذه الأخيرة بالذات هي الفارق الأوضح بين طالب لا يزال يكتب بصوته الشخصي وباحث يكتب بصوت العلم.

الركيزة الثانية هي الدقة المصطلحية: كل مفهوم يُعرَّف قبل استخدامه، وتُفضَّل الكلمات ذات المعنى المحدد الواحد على الكلمات العامة متعددة المعاني، فبدل sagen العامة تُستخدم äußern أو darlegen أو feststellen حسب الفرق الدقيق بينها (التعبير عن رأي، أم عرض حجة، أم إثبات نتيجة). والركيزة الثالثة هي التنوع المعجمي: تكرار نفس الفعل البسيط عبر الفقرة يُعد ضعفاً أسلوبياً، فيُنتظر من الكاتب أن يُبدّل بين مرادفات دقيقة، وهنا يلتقي هذا الدرس مباشرة بدرس الـ Funktionsverbgefüge، إذ إن eine Analyse durchführen أفضل أسلوبياً من analysieren وحدها في سياق أكاديمي رسمي.

أما الركيزة الرابعة فهي أدوات الربط المنطقي التي تنظم تسلسل الحجة: darüber hinaus وferner وzudem للإضافة، jedoch وhingegen وindessen للتعارض، folglich وdemnach وmithin للنتيجة، وd. h. ونämlich وbeispielsweise للتوضيح. هذه الأدوات أدق من عائلتها المألوفة aber/weil/deshalb لأنها تحدد نوع العلاقة المنطقية بدقة أكبر (نتيجة حتمية، أم تفسير، أم تعارض جزئي).

الخطأ الأكثر شيوعاً عند المتعلمين المتقدمين هو خلط السجلّين: يكتبون جملة أكاديمية دقيقة بصيغة المبني للمجهول ثم يُنهون الفقرة بـ ich denke، فيكسرون الاتساق الأسلوبي الذي بنوه للتو. الاتساق في اختيار السجل من أول الجملة إلى آخرها هو ما يحدد إن كان النص أكاديمياً فعلاً أو مجرد نص عادي مُثقَّل بمفردات صعبة.`,
        tables: [
          {
...
الخطأ الشائع عند المتعلمين المتقدمين هو محاولة استنتاج معنى تعبير جديد من سياقه فقط دون التأكد من معناه الحقيقي، أو استخدام تعبير مألوف في سياق رسمي لا يناسبه أبداً، إذ إن معظم هذه التعابير تنتمي إلى السجل الشفهي غير الرسمي ولا تُستخدم في الكتابة الأكاديمية أو المراسلات الرسمية.`,
    ...
    },
    {
      ...
      grammar: {
        ...
        content: `في هذا الدرس ننتقل من الألمانية "اليومية" التي أتقنتها في B2 إلى ما يُعرف بـ Bildungssprache أو لغة الإعلام والمؤسسات، وهي السجل الذي تُكتب به نشرات الأخبار والمقالات الاقتصادية والوثائق البرلمانية. هذا السجل لا يضيف مفردات جديدة فحسب، بل يفرض طريقة مختلفة في بناء الجملة: بدل "jemand hat das Gesetz verabschiedet" (شخص ما أقرّ القانون)، تفضّل الألمانية الصحفية حذف الفاعل والتركيز على الحدث نفسه: "Das Gesetz wurde verabschiedet". هذا هو الـ **Passiv** الموضوعي، وهو يخلق مسافة ونبرة حيادية توحي بأن الكلام تقرير لا رأي شخصي، وهي بالضبط النبرة التي يتوقعها ممتحن C1 في القراءة والكتابة.

الميزة الثانية لهذا السجل هي التركيب الاسمي Nominalstil: بدل الفعل "die Preise steigen" (ترتفع الأسعار) تجد الاسم المشتق "der Preisanstieg"، وبدل "die Wirtschaft wächst" تجد "das Wirtschaftswachstum". الألمانية تحوّل الأفعال إلى أسماء مركّبة طويلة بلاحقات ثابتة مثل -ung، -ion، -heit، -keit، وغالباً ما تكون هذه الأسماء مؤنثة. هذا يختلف جذرياً عن العربية التي تبني الجملة الاسمية عادة عبر الإضافة (ارتفاعُ الأسعار) لا عبر كلمة واحدة مركّبة، فحين تقرأ Arbeitslosenquote أو Handelsbilanz، درّب نفسك على تفكيك الكلمة إلى مكوناتها (Arbeitslose + Quote، Handel + Bilanz) بدل الشعور بالإرهاق أمام طولها.

أخيراً، الصحافة الألمانية مولعة بالاختصارات المؤسساتية (BIP، EU، وأسماء الأحزاب كـ CDU وSPD) التي تُفترض معرفتها مسبقاً دون شرح، تماماً كما تفترض الصحافة العربية معرفتك باختصارات مؤسسات وأحزاب معروفة.

الخطأ الشائع عند المتعلمين المتقدمين هو ترجمة هذه الأسماء المركّبة كلمة بكلمة بدل فهمها ككتلة دلالية واحدة، أو الإفراط في استخدام صيغة Aktiv الشخصية في كتاباتهم الأكاديمية، مما يجعل نصهم يبدو محادثة عادية لا تقريراً صحفياً رصيناً.`,
        tables: [
          {
      ...
      vocabulary: [
        ...
        { german: 'die Demokratie', arabic: 'الديمقراطية', gender: 'die', plural: 'Demokratien', type: 'noun' },
        { german: 'die Diktatur', arabic: 'الديكتاتورية', gender: 'die', plural: 'Diktaturen', type: 'noun' },
        { german: 'der Klimaschutz', arabic: 'حماية المناخ', gender: 'der', type: 'noun' },
        { german: 'die Krise', arabic: 'الأزمة', gender: 'die', plural: 'Krisen', type: 'noun' },
        { german: 'der Konjunktur', arabic: 'الوضع الاقتصادي', gender: 'der', type: 'noun' },
        { german: 'die Außenpolitik', arabic: 'السياسة الخارجية', gender: 'die', type: 'noun' },
        { german: 'die Innenpolitik', arabic: 'السياسة الداخلية', gender: 'die', type: 'noun' },
        { german: 'die Sicherheit', arabic: 'الأمن', gender: 'die', type: 'noun' },
        { german: 'der Konflikt', arabic: 'الصراع', gender: 'der', plural: 'Konflikte', type: 'noun' },
        { german: 'die Verfassung', arabic: 'الدستور', gender: 'die', plural: 'Verfassungen', type: 'noun' },
        { german: 'das Parlament', arabic: 'البرلمان', gender: 'das', plural: 'Parlamente', type: 'noun' },
        { german: 'der Minister', arabic: 'الوزير', gender: 'der', plural: 'Minister', type: 'noun' },
        { german: 'der Präsident', arabic: 'الرئيس', gender: 'der', plural: 'Präsidenten', type: 'noun' },
        { german: 'einführen', arabic: 'يستحدث', type: 'verb' },
        { german: 'reformieren', arabic: 'يُصلح', type: 'verb' },
        { german: 'sich auswirken', arabic: 'يؤثّر', type: 'verb' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'c1-09-q11', type: 'fill-blank', question: '"Die ___ ist im Quartal gestiegen." (التضخم)', answer: 'Inflation', hint: 'die Inflation' },
          { id: 'c1-09-q12', type: 'multiple-choice', question: 'البرلمان الألماني يُسمى:', options: ['das Parlament', 'der Bundestag', 'die Regierung', 'die Koalition'], answer: 'der Bundestag' },
          { id: 'c1-09-q13', type: 'fill-blank', question: '"Das Gesetz wurde im Bundestag ___." (verabschiedet)', answer: 'verabschiedet', hint: 'verabschieden → verabschiedet' },
          { id: 'c1-09-q14', type: 'multiple-choice', question: 'ما المختصر "BIP"؟', options: ['البطالة', 'الناتج المحلي الإجمالي', 'البرلمان', 'البنك'], answer: 'الناتج المحلي الإجمالي' },
          { id: 'c1-09-q15', type: 'matching', question: 'اربط:', pairs: [{ left: 'Bundestag', right: 'البرلمان' }, { left: 'Bundeskanzler', right: 'المستشار' }, { left: 'Inflation', right: 'التضخم' }, { left: 'Sanktion', right: 'العقوبة' }, { left: 'Wahl', right: 'الانتخابات' }], answer: 'matched' },
          { id: 'c1-09-q16', type: 'drag-drop', question: 'رتّب: "نمت الاقتصاد بنسبة 2 بالمئة"', words: ['Die', 'Wirtschaft', 'wuchs', 'um', '2', 'Prozent'], answer: 'Die Wirtschaft wuchs um 2 Prozent' },
          { id: 'c1-09-q17', type: 'speaking', question: 'قل: "تتفاوض الحكومة مع المعارضة"', answer: 'Die Regierung verhandelt mit der Opposition' },
          { id: 'c1-09-q18', type: 'fill-blank', question: 'استمع: "Die ___ wurden verhängt." (العقوبات)', audioPrompt: 'Die Sanktionen wurden verhängt.', answer: 'Sanktionen', hint: 'die Sanktion (pl)' },
          { id: 'c1-09-q19', type: 'multiple-choice', question: 'الجريدة الأنسب للتدريب على B2/C1:', options: ['BILD', 'FAZ / Süddeutsche', 'Bunte', 'TV Spielfilm'], answer: 'FAZ / Süddeutsche' },
          { id: 'c1-09-q20', type: 'drag-drop', question: 'رتّب: "تنخفض البطالة في ألمانيا"', words: ['Die', 'Arbeitslosenquote', 'sinkt', 'in', 'Deutschland'], answer: 'Die Arbeitslosenquote sinkt in Deutschland' },
        ],
      },
    },
    {
...
إضافة إلى ذلك، يُطلب منك أحياناً وضع العمل في سياقه التاريخي عبر معرفة العصور الأدبية الألمانية الكبرى، Aufklärung وRomantik وRealismus وExpressionismus وغيرها، وربط الكاتب بعصره وتياره الفكري، تماماً كما تربط في العربية بين شاعر جاهلي أو عباسي وسياقه. الفرق أن الامتحان الألماني يتوقع منك أسماء وتواريخ محددة، لا انطباعاً عاماً فقط.`,
      ...
      vocabulary: [
        ...
        { german: 'der Reim', arabic: 'القافية', gender: 'der', plural: 'Reime', type: 'noun' },
        { german: 'der Stil', arabic: 'الأسلوب', gender: 'der', plural: 'Stile', type: 'noun' },
        { german: 'das Stilmittel', arabic: 'الأداة الأسلوبية', gender: 'das', plural: 'Stilmittel', type: 'noun' },
        { german: 'die Allegorie', arabic: 'المجاز / الكناية', gender: 'die', plural: 'Allegorien', type: 'noun' },
        { german: 'die Ironie', arabic: 'السخرية', gender: 'die', type: 'noun' },
        { german: 'die Spannung', arabic: 'التشويق', gender: 'die', plural: 'Spannungen', type: 'noun' },
        { german: 'das Werk', arabic: 'العمل الأدبي', gender: 'das', plural: 'Werke', type: 'noun' },
        { german: 'die Figur', arabic: 'الشخصية', gender: 'die', plural: 'Figuren', type: 'noun' },
        { german: 'das Thema', arabic: 'الموضوع', gender: 'das', plural: 'Themen', type: 'noun' },
        { german: 'die Botschaft', arabic: 'الرسالة', gender: 'die', plural: 'Botschaften', type: 'noun' },
        { german: 'die Perspektive', arabic: 'المنظور', gender: 'die', plural: 'Perspektiven', type: 'noun' },
        { german: 'rezipieren', arabic: 'يستقبل / يقرأ', type: 'verb' },
        { german: 'erzählen', arabic: 'يروي', type: 'verb' },
        { german: 'darstellen', arabic: 'يصوّر', type: 'verb' },
        { german: 'tragisch', arabic: 'مأساوي', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'c1-10-q11', type: 'fill-blank', question: '"Das ___ verdeutlicht die innere Zerrissenheit." (الاستعارة)', answer: 'Symbol', hint: 'das Symbol أو die Metapher' },
          { id: 'c1-10-q12', type: 'multiple-choice', question: 'الأنواع الأدبية الرئيسية:', options: ['Epik, Lyrik, Dramatik', 'Roman، Gedicht، Oper', 'Brief، Tagebuch، Bericht', 'فقط الرواية'], answer: 'Epik, Lyrik, Dramatik' },
          { id: 'c1-10-q13', type: 'fill-blank', question: '"Die Erzählung wird aus der Perspektive des ___ erzählt." (الراوي)', answer: 'Erzählers', hint: 'der Erzähler → Genitiv' },
          { id: 'c1-10-q14', type: 'multiple-choice', question: 'كافكا ينتمي إلى:', options: ['Klassik', 'Romantik', 'Expressionismus', 'Realismus'], answer: 'Expressionismus' },
          { id: 'c1-10-q15', type: 'matching', question: 'اربط:', pairs: [{ left: 'Goethe', right: 'Klassik' }, { left: 'Kafka', right: 'Expressionismus' }, { left: 'Brecht', right: 'episches Theater' }, { left: 'Brüder Grimm', right: 'Romantik' }, { left: 'Fontane', right: 'Realismus' }], answer: 'matched' },
          { id: 'c1-10-q16', type: 'drag-drop', question: 'رتّب: "تدور أحداث الرواية في القرن التاسع عشر"', words: ['Der', 'Roman', 'spielt', 'im', '19.', 'Jahrhundert'], answer: 'Der Roman spielt im 19. Jahrhundert' },
          { id: 'c1-10-q17', type: 'speaking', question: 'قل: "هذه القصة تتحدّث عن صراع بين الأجيال"', answer: 'Diese Geschichte handelt von einem Generationenkonflikt' },
          { id: 'c1-10-q18', type: 'fill-blank', question: 'استمع: "Die ___ steht im Mittelpunkt." (الشخصية الرئيسية)', audioPrompt: 'Die Hauptfigur steht im Mittelpunkt.', answer: 'Hauptfigur', hint: 'die Hauptfigur' },
          { id: 'c1-10-q19', type: 'multiple-choice', question: '"Sturm und Drang" هو:', options: ['عاصفة وضغط', 'حركة أدبية ألمانية', 'كتاب لشيلر', 'رواية لغوته'], answer: 'حركة أدبية ألمانية' },
          { id: 'c1-10-q20', type: 'drag-drop', question: 'رتّب: "يستخدم المؤلف استعارات متعددة"', words: ['Der', 'Autor', 'verwendet', 'mehrere', 'Metaphern'], answer: 'Der Autor verwendet mehrere Metaphern' },
        ],
      },
    },
    {
      ...
      grammar: {
        ...
        content: `في مستوى C1 لا يكفي أن تتحدث الألمانية بطلاقة؛ يُقيَّم القسم الشفهي من الامتحان، Goethe-Zertifikat C1 أو TestDaF Mündlich، على قدرتك على بناء عرض متماسك ومُهيكل والمشاركة في نقاش بأسلوب دبلوماسي واثق. هذا سجل مختلف عن الحديث العفوي اليومي الذي أتقنته في B2؛ إنه أقرب لما يُسمى Bildungssprache الشفهية: جمل مكتملة، انتقالات واضحة، وتحفّظ لبق عند الاختلاف في الرأي.

هيكل العرض الرسمي يتبع ثلاث مراحل واضحة يُتوقع أن تُشير إليها صراحة بعبارات ربط، لا بالمحتوى وحده: مقدمة تُعلن فيها الموضوع وخطة العرض ("Ich werde in drei Schritten vorgehen")، ثم جزء رئيسي تنتقل فيه بين النقاط بعبارات مثل zunächst وals Nächstes وschließlich، ثم خاتمة تلخّص وتفتح باب الأسئلة. هذه الإشارات اللغوية الصريحة، Gliederungssignale، هي ما يميّز عرضاً بمستوى C1 عن سرد عشوائي للأفكار بمستوى B1 أو B2؛ فالممتحن يستمع لمنطق ترتيبك بقدر ما يستمع لصحة قواعدك.

أما في النقاش، فالمهارة الأدق هي التعبير عن الاختلاف دون فظاظة، وهي مهارة لغوية اجتماعية تختلف غالباً عن حدسك القادم من العربية المغربية العامية، حيث الاعتراض المباشر (لا، هذا غير صحيح) مقبول اجتماعياً في نقاشات كثيرة. الألمانية الأكاديمية تفضّل **تخفيف الاعتراض**: تعترف أولاً بوجهة نظر المحاور ("Ich kann Ihren Standpunkt nachvollziehen") ثم تُدخل اعتراضك بأداة تحويلية لطيفة مثل jedoch أو allerdings بدل الرفض المباشر. حتى الموافقة لها درجات: "Dem kann ich nur zustimmen" اتفاق قوي، بينما "Da haben Sie teilweise recht, aber..." اتفاق جزئي محسوب.

الخطأ الأكثر شيوعاً عند المتعلمين المتقدمين هو أحد أمرين متناقضين: إما الدخول في اعتراض مباشر وحاد يصطدم بتوقعات السجل الرسمي، أو في الاتجاه المعاكس، تجنّب الاختلاف كلياً خوفاً من الخطأ فيبدو الكلام موافقاً دائماً وباهتاً. الكفاءة الحقيقية في C1 هي إتقان الوسط اللبق: رأي واضح لكن مُغلّف بعبارات تحفظ ماء الوجه للطرفين.`,
        tables: [
          {
            title: 'تعبيرات العرض',
      ...
      vocabulary: [
        ...
        { german: 'die Argumentation', arabic: 'الحجاج', gender: 'die', plural: 'Argumentationen', type: 'noun' },
        { german: 'der Übergang', arabic: 'الانتقال', gender: 'der', plural: 'Übergänge', type: 'noun' },
        { german: 'die Folie', arabic: 'الشريحة (PowerPoint)', gender: 'die', plural: 'Folien', type: 'noun' },
        { german: 'die Statistik', arabic: 'الإحصاءات', gender: 'die', plural: 'Statistiken', type: 'noun' },
        { german: 'das Diagramm', arabic: 'الرسم البياني', gender: 'das', plural: 'Diagramme', type: 'noun' },
        { german: 'gliedern', arabic: 'يقسّم', type: 'verb' },
        { german: 'untermauern', arabic: 'يُعزّز', type: 'verb' },
        { german: 'ausführen', arabic: 'يُفصّل', type: 'verb' },
        { german: 'hervorheben', arabic: 'يُبرز', type: 'verb' },
        { german: 'klären', arabic: 'يُوضّح', type: 'verb' },
        { german: 'aufgreifen', arabic: 'يلتقط / يتناول', type: 'verb' },
        { german: 'plädieren für', arabic: 'يدعو لـ', type: 'verb' },
        { german: 'in diesem Zusammenhang', arabic: 'في هذا السياق', type: 'phrase' },
        { german: 'an dieser Stelle', arabic: 'في هذه النقطة', type: 'phrase' },
        { german: 'kompetent', arabic: 'كفؤ', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'c1-11-q11', type: 'fill-blank', question: '"___ komme ich zu meiner Einschätzung." (في الختام)', answer: 'Abschließend', hint: 'في النهاية' },
          { id: 'c1-11-q12', type: 'multiple-choice', question: 'لتلخيص رأي شخص آخر:', options: ['Sie haben Unrecht.', 'Wenn ich Sie richtig verstehe...', 'Was sagen Sie?', 'Bitte schweigen Sie.'], answer: 'Wenn ich Sie richtig verstehe...' },
          { id: 'c1-11-q13', type: 'fill-blank', question: '"Da haben Sie ___ recht, aber..." (جزئياً)', answer: 'teilweise', hint: 'اتفاق جزئي' },
          { id: 'c1-11-q14', type: 'multiple-choice', question: 'في عرض جيد، يجب:', options: ['عدم استعمال أدوات الربط', 'استعمال أدوات ربط لتنظيم الأفكار', 'استعمال كلمات عامية فقط', 'تجنب أمثلة'], answer: 'استعمال أدوات ربط لتنظيم الأفكار' },
          { id: 'c1-11-q15', type: 'matching', question: 'اربط الوظيفة بتعبير:', pairs: [{ left: 'إبداء رأي', right: 'Meiner Meinung nach' }, { left: 'اتفاق قوي', right: 'Dem kann ich nur zustimmen' }, { left: 'اختلاف لبق', right: 'Ich sehe das differenzierter' }, { left: 'تلخيص', right: 'Wenn ich Sie richtig verstehe' }, { left: 'بداية', right: 'Zunächst' }], answer: 'matched' },
          { id: 'c1-11-q16', type: 'drag-drop', question: 'رتّب: "اسمحوا لي أن أُبرز هذه النقطة"', words: ['Erlauben', 'Sie', 'mir,', 'diesen', 'Punkt', 'hervorzuheben'], answer: 'Erlauben Sie mir, diesen Punkt hervorzuheben' },
          { id: 'c1-11-q17', type: 'speaking', question: 'قل: "أتفق معك من حيث المبدأ، ولكن..."', answer: 'Da stimme ich Ihnen grundsätzlich zu, jedoch' },
          { id: 'c1-11-q18', type: 'fill-blank', question: 'استمع: "Vielen Dank für Ihre ___." (الاهتمام)', audioPrompt: 'Vielen Dank für Ihre Aufmerksamkeit.', answer: 'Aufmerksamkeit', hint: 'die Aufmerksamkeit' },
          { id: 'c1-11-q19', type: 'multiple-choice', question: 'لاختلاف حازم نقول:', options: ['Vielleicht...', 'Dem muss ich entschieden widersprechen', 'Quatsch', 'Egal'], answer: 'Dem muss ich entschieden widersprechen' },
          { id: 'c1-11-q20', type: 'drag-drop', question: 'رتّب: "هل هناك أسئلة في الختام؟"', words: ['Gibt', 'es', 'abschließend', 'noch', 'Fragen'], answer: 'Gibt es abschließend noch Fragen' },
        ],
      },
    },
    {
      ...
      grammar: {
        ...
        content: `هذا الدرس الختامي ليس قاعدة جديدة بل خريطة ربط بين كل الأدوات التي بنيت بها لغتك الألمانية المتقدمة على مدار مستوى C1. الفكرة المحورية التي يجب أن تستوعبها الآن هي أن الفرق بين B2 وC1 ليس معرفة قواعد أكثر، بل **القدرة على الاختيار الواعي** بين عدة صيغ متاحة للتعبير عن المعنى نفسه تقريباً، حسب درجة الرسمية والدقة والنبرة المطلوبة. متحدث B2 يعرف طريقة واحدة لقول الشيء؛ متحدث C1 يعرف ثلاثاً أو أربعاً ويختار بينها بوعي أسلوبي.

خذ مثلاً التعبير عن الشرط غير الواقعي: يمكنك قول "Wenn ich Zeit hätte, würde ich kommen"، الصيغة الأساسية، أو الأكثر أناقة "Hätte ich Zeit, käme ich" بحذف wenn وتقديم الفعل المصرَّف، وهذا الاختيار الثاني إشارة أسلوبية صريحة إلى أنك تتحكم في اللغة لا العكس. وخذ التعبير عن الإمكانية: "man kann das lösen" مقابل "das lässt sich lösen" مقابل "das ist zu lösen"، ثلاث طرق لصياغة الفكرة نفسها بدرجات رسمية متفاوتة، وهذا ما يُسمى Passiversatzformen، وكل واحدة تناسب سياقاً مختلفاً.

هذا التنويع يمتد أيضاً إلى الوصف: بدل جملتين منفصلتين "Ein Mann schläft. Der Mann liegt auf der Bank"، يدمج متحدث C1 المعلومة في صفة مشتقة من الفعل، وهذا هو Partizipialattribut: "der schlafende Mann auf der Bank". هذا يُظهر قدرة على ضغط المعلومات في بنية واحدة أنيقة، وهي مهارة أساسية في الكتابة الأكاديمية حيث الإيجاز والدقة مطلوبان معاً. وعلى مستوى الربط بين الجمل، تحل أدوات مثل folglich وdarüber hinaus وhingegen محل الروابط البسيطة deshalb وaber التي تعلمتها في مستويات سابقة؛ الفكرة المنطقية واحدة، نتيجة أو إضافة أو تعارض، لكن السجل يرتفع درجة.

الخطأ الأخطر في هذه المرحلة ليس عدم معرفة هذه الصيغ المتقدمة، بل استخدامها بشكل متكلّف ومفرط في كل جملة حتى يفقد النص طبيعيته، أو العكس: حفظها بمعزل عن السياق فتظهر صحيحة نحوياً لكن في غير موضعها الأسلوبي المناسب، كاستخدام mithin في محادثة عابرة. الكفاءة الحقيقية بمستوى C1 هي معرفة متى تستخدم الصيغة المتقدمة ومتى تكتفي بالبسيطة، لا استخدامها آلياً في كل مكان.`,
        tables: [
          {
            title: 'ملخص قواعد C1',
      ...
      vocabulary: [
        ...
        { german: 'die Beherrschung', arabic: 'الإتقان', gender: 'die', type: 'noun' },
        { german: 'die Sprachgewandtheit', arabic: 'الفصاحة اللغوية', gender: 'die', type: 'noun' },
        { german: 'der Eindruck', arabic: 'الانطباع', gender: 'der', plural: 'Eindrücke', type: 'noun' },
        { german: 'die Wendung', arabic: 'التعبير الاصطلاحي', gender: 'die', plural: 'Wendungen', type: 'noun' },
        { german: 'die Nuance', arabic: 'الفارق الدقيق', gender: 'die', plural: 'Nuancen', type: 'noun' },
        { german: 'die Bedeutungsebene', arabic: 'الطبقة الدلالية', gender: 'die', plural: 'Bedeutungsebenen', type: 'noun' },
        { german: 'die Sprachkompetenz', arabic: 'الكفاءة اللغوية', gender: 'die', type: 'noun' },
        { german: 'die Stilistik', arabic: 'علم الأسلوب', gender: 'die', type: 'noun' },
        { german: 'die Idiomatik', arabic: 'علم التعابير', gender: 'die', type: 'noun' },
        { german: 'sich aneignen', arabic: 'يكتسب', type: 'verb' },
        { german: 'verfeinern', arabic: 'يصقُل', type: 'verb' },
        { german: 'beherrschen', arabic: 'يتقن', type: 'verb' },
        { german: 'mühelos', arabic: 'بلا عناء', type: 'adjective' },
        { german: 'professionell', arabic: 'احترافي', type: 'adjective' },
        { german: 'muttersprachlich', arabic: 'كأم اللغة', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'c1-12-q11', type: 'fill-blank', question: '"Hätten wir mehr Zeit, ___ wir intensiver recherchieren." (würden)', answer: 'würden', hint: 'Konjunktiv II' },
          { id: 'c1-12-q12', type: 'multiple-choice', question: 'بعد C1 يمكن:', options: ['البدء من A1', 'الانتقال إلى C2 / TestDaF', 'فقط القراءة', 'لا شيء'], answer: 'الانتقال إلى C2 / TestDaF' },
          { id: 'c1-12-q13', type: 'fill-blank', question: '"Folglich ist davon ___, dass weitere Reformen nötig sind." (auszugehen)', answer: 'auszugehen', hint: 'davon auszugehen' },
          { id: 'c1-12-q14', type: 'multiple-choice', question: 'C1 يكفي لـ:', options: ['زيارة قصيرة فقط', 'الدراسة الجامعية والوظائف الأكاديمية', 'فقط الترجمة', 'لا شيء'], answer: 'الدراسة الجامعية والوظائف الأكاديمية' },
          { id: 'c1-12-q15', type: 'matching', question: 'اربط مصطلح C1 بمعناه:', pairs: [{ left: 'Konjunktiv II Vergangenheit', right: 'hätte/wäre + Partizip II' }, { left: 'n-Deklination', right: 'der Mensch → den Menschen' }, { left: 'FVG', right: 'eine Entscheidung treffen' }, { left: 'Funktionsverbgefüge', right: 'فعل + اسم رسمي' }, { left: 'Konditional ohne wenn', right: 'Hätte ich Zeit, würde ich' }], answer: 'matched' },
          { id: 'c1-12-q16', type: 'drag-drop', question: 'رتّب: "أنا أتقن الألمانية على مستوى C1"', words: ['Ich', 'beherrsche', 'Deutsch', 'auf', 'C1-Niveau'], answer: 'Ich beherrsche Deutsch auf C1-Niveau' },
          { id: 'c1-12-q17', type: 'speaking', question: 'قل: "بعد C1، يمكنني الدراسة في الجامعات الألمانية"', answer: 'Nach C1 kann ich an deutschen Universitäten studieren' },
          { id: 'c1-12-q18', type: 'fill-blank', question: 'استمع: "Ich werde meine Sprachkenntnisse weiter ___." (verfeinern)', audioPrompt: 'Ich werde meine Sprachkenntnisse weiter verfeinern.', answer: 'verfeinern', hint: 'يصقُل' },
          { id: 'c1-12-q19', type: 'multiple-choice', question: 'الامتحانات الألمانية المتقدمة:', options: ['نفس A1', 'TestDaF و C2', 'فقط الكتابة', 'بدون امتحانات'], answer: 'TestDaF و C2' },
          { id: 'c1-12-q20', type: 'drag-drop', question: 'رتّب: "تهانينا، لقد أنجزت C1!"', words: ['Glückwunsch!', 'Du', 'hast', 'C1', 'geschafft'], answer: 'Glückwunsch! Du hast C1 geschafft' },
        ],
      },
    },
    // ─────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────
    {
      ...
      grammar: {
        ...
        content: `في كل لغة أسلوبان أساسيان للتعبير عن الحدث: أسلوب يجعل الفعل مركز الجملة، وأسلوب يحوّل الحدث نفسه إلى اسم مجرد يُعامَل كأنه شيء قائم بذاته. في الألمانية يُسمّى الأول Verbalstil ويُسمّى الثاني Nominalstil، والانتقال السلس بينهما هو أحد أوضح علامات إتقان اللغة على مستوى C1، لأنه لا يتعلق بالصواب النحوي بل بالملاءمة الأسلوبية: أي صيغة تناسب أي سياق.\n\nVerbalstil يبني الجملة حول فعل تصريفي داخل جملة رئيسية وجملة فرعية مرتبطتين بأداة ربط مثل wenn أو weil أو obwohl، كما في: Wenn die Preise steigen, sinkt der Konsum. هذا الأسلوب أقرب إلى منطق الجملة الفعلية في العربية، وهو الأوضح والأكثر طبيعية في الكلام اليومي والحوار، لأنه يحافظ على تسلسل الأحداث زمنياً وسببياً بشكل صريح.\n\nNominalstil يستبدل الجملة الفرعية بأكملها بمجموعة اسمية واحدة مسبوقة بحرف جر مناسب (bei, durch, nach, trotz, wegen, vor...)، فتصبح الجملة السابقة: Bei Preisanstieg sinkt der Konsum. هنا اختفى الفعل steigen تماماً وتحوّل إلى اسم مجرد (Nominalisierung)، وأصبحت الجملة كلها جملة واحدة أكثر كثافة وإيجازاً. هذا الأسلوب هو المهيمن في اللغة الصحفية والعلمية والإدارية الألمانية، لأنه يسمح بحشد معلومات كثيرة في مساحة أصغر، ويمنح النص طابعاً موضوعياً غير شخصي يناسب التقارير والدراسات.\n\nمن الناحية الميكانيكية، عملية التحويل تمر بثلاث خطوات: أولاً تحديد الفعل الذي سيُحوَّل إلى اسم (غالباً بإضافة ung أو تغيير الجذر كما في steigen → der Anstieg)، ثانياً اختيار حرف الجر الذي يعكس العلاقة المنطقية الأصلية للأداة الرابطة (wenn/als → bei، weil/da → wegen، obwohl → trotz، nachdem → nach، bevor → vor)، وثالثاً وضع الاسم الناتج في الحالة التي يفرضها ذلك الحرف، جر (Dativ) أو إضافة (Genitiv).\n\nالخطأ الأكثر شيوعاً لدى المتعلمين المتقدمين هو الإفراط في استعمال Nominalstil ظناً منهم أنه أرقى في كل سياق، فتتحول الفقرة إلى سلسلة من الأسماء المركّبة الثقيلة يصعب فك شفرتها حتى على القارئ الألماني نفسه، كما في Die Verbesserung der Qualität durch Optimierung der Prozesse بدلاً من الصيغة الأوضح Wir verbessern die Qualität, indem wir die Prozesse optimieren. الأسلوب الجيد في الكتابة الأكاديمية يمزج بين الاثنين بوعي: يستعمل Nominalstil لتكثيف الأفكار الثانوية، ويعود إلى Verbalstil كلما احتاج النص إلى الوضوح المباشر.`,
        tables: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      grammar: {
        ...
        content: `بعد أن يتقن متعلم الألمانية بناء الجملة المفردة بشكل سليم، يبقى أمامه تحدٍّ أسلوبي أرقى: كيف يربط بين عدة أفكار في نص متماسك؟ اللغة الألمانية تتيح إستراتيجيتين متقابلتين تماماً لهذا الربط، ويُعرف اختيار إحداهما أو المزج بينهما بوعي كأحد أدق مؤشرات المستوى C1، لأنه ينقل الكفاءة من الجملة الصحيحة إلى النص المُتقَن الإيقاع.\n\nParataxe (الترصيف الجملي) يعني وضع جمل رئيسية مستقلة متتالية دون تداخل بينها، كل واحدة تحمل فكرة واحدة وتنتهي، مثل: Es regnet. Wir bleiben zu Hause. Wir lesen Bücher. هذا الأسلوب أقرب إلى منطق الكلام العفوي، فهو سريع الإيقاع، سهل الفهم فوراً، ويُستعمل بكثافة في الأخبار الصحفية القصيرة والخطابة العامة، لأنه يمنح كل جملة وزنها الخاص ويخلق تأثيراً من الحزم والوضوح، كما في الجملة الشهيرة Er kam. Er sah. Er siegte.\n\nHypotaxe (التراكب الجملي) على النقيض يبني جملة رئيسية واحدة تتفرّع منها جمل فرعية متعددة متداخلة أحياناً في بعضها البعض، فتصبح الفكرة كلها معلّقة داخل بنية واحدة معقدة، كما في: Da es regnet, bleiben wir, weil wir nicht nass werden wollen, zu Hause, wo wir Bücher lesen können, die wir lange aufgeschoben haben. هذا النمط هو السائد في الكتابة الأكاديمية والأدبية الرفيعة، لأنه يسمح بالتعبير عن علاقات منطقية دقيقة، سبب داخل نتيجة داخل وصف، في جملة واحدة متماسكة، لكنه يتطلب من القارئ تركيزاً أكبر لأن الفعل المصرَّف يتأخر غالباً إلى نهاية كل جملة فرعية.\n\nمن الناحية العملية، بناء Hypotaxe جيد يمر بخطوات: تُحدَّد الفكرة المركزية كجملة رئيسية، ثم تُلحق بها الأفكار الثانوية (سبب، نتيجة، شرط، وصف) كل واحدة بأداة الربط المناسبة (da أو weil للسبب، sodass للنتيجة، الجملة الموصولة للوصف)، مع الانتباه إلى ألا يتجاوز التداخل أربعة مستويات، لأن ما يتجاوز ذلك يصبح غامضاً حتى للقارئ الألماني الأصلي، كما يوضح المثال المتعمّد التعقيد Die Tatsache, dass die Studie, die wir gestern gelesen haben, in der die Daten... analysiert werden.\n\nخلافاً لتصوّر شائع لدى المتعلمين المتقدمين، فإن الكاتب الألماني الماهر لا يستعمل Hypotaxe حصراً باعتباره الأسلوب الراقي، بل يتعمّد المزج: فقرة أكاديمية تفتتح بجملة Hypotaxe طويلة تُرسي الحجة، ثم تُختتم بجملتين قصيرتين من نوع Parataxe لخلق تأثير تأكيدي حاسم، كما في Obwohl es schwer war, haben wir es geschafft. Es war hart. Aber wir sind hier. الخطأ الأكثر شيوعاً هو كتابة فقرة كاملة بجمل Hypotaxe متراكمة دون أي جملة قصيرة تُريح القارئ، فينتج نص ثقيل يفقد قارئه رغم صحته النحوية الكاملة.`,
        tables: [
