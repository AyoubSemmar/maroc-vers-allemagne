...
**تحذير:** تعلم التعابير في سياق كامل؛ ترجمتها الحرفية تخدع.`,
      ...
      vocabulary: [
        ...
        { german: 'jdm. einen Bären aufbinden', arabic: 'يخدع شخصاً', type: 'phrase' },
        { german: 'sich aus dem Staub machen', arabic: 'يهرب', type: 'phrase' },
        { german: 'auf den Punkt bringen', arabic: 'يلخّص بدقة', type: 'phrase' },
        { german: 'bei null anfangen', arabic: 'يبدأ من الصفر', type: 'phrase' },
        { german: 'das ist nicht mein Bier', arabic: 'هذا ليس شأني', type: 'phrase' },
        { german: 'unter vier Augen', arabic: 'وجهاً لوجه (خصوصية)', type: 'phrase' },
        { german: 'Hals- und Beinbruch', arabic: 'حظاً سعيداً', type: 'phrase' },
        { german: 'jdm. auf die Pelle rücken', arabic: 'يلحّ على شخص', type: 'phrase' },
        { german: 'da steh ich auf dem Schlauch', arabic: 'لست أفهم', type: 'phrase' },
        { german: 'alle Hände voll zu tun haben', arabic: 'مشغول جداً', type: 'phrase' },
        { german: 'ein Auge zudrücken', arabic: 'يتغاضى', type: 'phrase' },
        { german: 'ohne Wenn und Aber', arabic: 'بلا تردد', type: 'phrase' },
        { german: 'eine harte Nuss', arabic: 'تحدٍّ صعب', type: 'phrase' },
        { german: 'jdm. den Boden unter den Füßen wegziehen', arabic: 'يصدم بشكل كبير', type: 'phrase' },
        { german: 'Lampenfieber haben', arabic: 'يخاف قبل العرض', type: 'phrase' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'c1-08-q11', type: 'fill-blank', question: '"Hals- und ___!" (تمنّي حظ سعيد)', answer: 'Beinbruch', hint: 'Hals- und Beinbruch' },
          { id: 'c1-08-q12', type: 'multiple-choice', question: 'ما معنى "Schwein haben"؟', options: ['عنده خنزير', 'يحالفه الحظ', 'يأكل لحم خنزير', 'يخسر'], answer: 'يحالفه الحظ' },
          { id: 'c1-08-q13', type: 'fill-blank', question: '"Ich verstehe nur ___." (لا أفهم)', answer: 'Bahnhof', hint: 'تعبير ألماني' },
          { id: 'c1-08-q14', type: 'multiple-choice', question: '"unter vier Augen" تعني:', options: ['أربع أعين', 'بصراحة بين شخصين', 'بنظارة', 'بحذر'], answer: 'بصراحة بين شخصين' },
          { id: 'c1-08-q15', type: 'matching', question: 'اربط التعبير بالمعنى:', pairs: [{ left: 'Schwein haben', right: 'يحالفه الحظ' }, { left: 'die Nase voll haben', right: 'سئم' }, { left: 'auf Wolke 7', right: 'سعيد جداً' }, { left: 'Lampenfieber haben', right: 'يرتجف قبل العرض' }, { left: 'Bahnhof verstehen', right: 'لا يفهم' }], answer: 'matched' },
          { id: 'c1-08-q16', type: 'drag-drop', question: 'رتّب: "هذا الأمر ليس شأني"', words: ['Das', 'ist', 'nicht', 'mein', 'Bier'], answer: 'Das ist nicht mein Bier' },
          { id: 'c1-08-q17', type: 'speaking', question: 'قل: "أنا مشغول جداً"', answer: 'Ich habe alle Hände voll zu tun' },
          { id: 'c1-08-q18', type: 'fill-blank', question: 'استمع: "Er hat ein ___ zugedrückt." (تغاضى)', audioPrompt: 'Er hat ein Auge zugedrückt.', answer: 'Auge', hint: 'das Auge' },
          { id: 'c1-08-q19', type: 'multiple-choice', question: '"den Stier bei den Hörnern packen" تعني:', options: ['يربّي الأبقار', 'يواجه المشكلة بشجاعة', 'يهرب', 'يصرخ'], answer: 'يواجه المشكلة بشجاعة' },
          { id: 'c1-08-q20', type: 'drag-drop', question: 'رتّب: "تتمنى لي حظاً موفقاً قبل العرض"', words: ['Du', 'drückst', 'mir', 'vor', 'der', 'Präsentation', 'die', 'Daumen'], answer: 'Du drückst mir vor der Präsentation die Daumen' },
        ],
      },
    },
    {
