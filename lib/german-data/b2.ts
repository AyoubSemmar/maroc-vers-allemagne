...
⚠️ الأسلوب الاسمي مختصر ورسمي — شائع في القوانين والمقالات.`,
      ...
      vocabulary: [
        ...
        { german: 'die Bedeutung', arabic: 'الأهمية / المعنى', plural: 'die Bedeutungen', type: 'noun', gender: 'die' },
        { german: 'die Wirkung', arabic: 'التأثير', plural: 'die Wirkungen', type: 'noun', gender: 'die' },
        { german: 'die Folge', arabic: 'النتيجة / التبعة', plural: 'die Folgen', type: 'noun', gender: 'die' },
        { german: 'die Wahrnehmung', arabic: 'الإدراك', plural: 'die Wahrnehmungen', type: 'noun', gender: 'die' },
        { german: 'die Mitteilung', arabic: 'الإبلاغ', plural: 'die Mitteilungen', type: 'noun', gender: 'die' },
        { german: 'die Forderung', arabic: 'المطالبة', plural: 'die Forderungen', type: 'noun', gender: 'die' },
        { german: 'die Empfehlung', arabic: 'التوصية', plural: 'die Empfehlungen', type: 'noun', gender: 'die' },
        { german: 'die Förderung', arabic: 'الدعم', plural: 'die Förderungen', type: 'noun', gender: 'die' },
        { german: 'die Verbreitung', arabic: 'الانتشار', type: 'noun', gender: 'die' },
        { german: 'die Übersetzung', arabic: 'الترجمة', plural: 'die Übersetzungen', type: 'noun', gender: 'die' },
        { german: 'der Vergleich', arabic: 'المقارنة', plural: 'die Vergleiche', type: 'noun', gender: 'der' },
        { german: 'die Auswirkung', arabic: 'الأثر', plural: 'die Auswirkungen', type: 'noun', gender: 'die' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-01-q11', type: 'fill-blank', question: 'حوّل: "die Wirtschaft entwickelt sich" → "die ___ der Wirtschaft"', answer: 'Entwicklung', hint: 'entwickeln → die Entwicklung' },
          { id: 'b2-01-q12', type: 'multiple-choice', question: 'الاسم من "untersuchen":', options: ['die Untersuchung', 'der Untersuch', 'das Untersuchen', 'die Untersuche'], answer: 'die Untersuchung' },
          { id: 'b2-01-q13', type: 'fill-blank', question: 'أكمل: "Die ___ der Preise ist hoch." (الارتفاع)', answer: 'Erhöhung', hint: 'erhöhen → die Erhöhung' },
          { id: 'b2-01-q14', type: 'multiple-choice', question: 'الجملة الأكثر "Nominalstil":', options: ['Wir entwickeln das Produkt.', 'Bei der Entwicklung des Produkts...', 'Das Produkt wird entwickelt.', 'Wir haben entwickelt.'], answer: 'Bei der Entwicklung des Produkts...' },
          { id: 'b2-01-q15', type: 'matching', question: 'اربط الفعل بالاسم:', pairs: [{ left: 'wirken', right: 'die Wirkung' }, { left: 'fordern', right: 'die Forderung' }, { left: 'übersetzen', right: 'die Übersetzung' }, { left: 'vergleichen', right: 'der Vergleich' }, { left: 'empfehlen', right: 'die Empfehlung' }], answer: 'matched' },
          { id: 'b2-01-q16', type: 'drag-drop', question: 'رتّب (Nominalstil): "نمو الاقتصاد سريع"', words: ['Das', 'Wachstum', 'der', 'Wirtschaft', 'ist', 'rasant'], answer: 'Das Wachstum der Wirtschaft ist rasant' },
          { id: 'b2-01-q17', type: 'speaking', question: 'قل بالألمانية: "إنتشار الإنترنت كان سريعاً"', answer: 'Die Verbreitung des Internets war schnell' },
          { id: 'b2-01-q18', type: 'fill-blank', question: 'استمع: "Die ___ auf die Umwelt ist groß." (الأثر)', audioPrompt: 'Die Auswirkung auf die Umwelt ist groß.', answer: 'Auswirkung', hint: 'sich auswirken → die Auswirkung' },
          { id: 'b2-01-q19', type: 'multiple-choice', question: 'متى نستعمل Nominalstil؟', options: ['الكلام اليومي', 'النصوص الرسمية والصحفية', 'الإعلانات فقط', 'الشعر'], answer: 'النصوص الرسمية والصحفية' },
          { id: 'b2-01-q20', type: 'drag-drop', question: 'رتّب: "بعد ترجمة النص فهمت كل شيء"', words: ['Nach', 'der', 'Übersetzung', 'des', 'Textes', 'verstand', 'ich', 'alles'], answer: 'Nach der Übersetzung des Textes verstand ich alles' },
        ],
      },
    },
    // ========================= LESSON 2 =========================
...
⚠️ كلا النوعين يتبع قواعد **Adjektivdeklination** (-e/-en حسب الحالة).`,
      ...
      vocabulary: [
        ...
        { german: 'die Bevölkerung', arabic: 'السكان', type: 'noun', gender: 'die' },
        { german: 'das Gesicht', arabic: 'الوجه', plural: 'die Gesichter', type: 'noun', gender: 'das' },
        { german: 'die Tür', arabic: 'الباب', plural: 'die Türen', type: 'noun', gender: 'die' },
        { german: 'das Fenster', arabic: 'النافذة', plural: 'die Fenster', type: 'noun', gender: 'das' },
        { german: 'das Brot', arabic: 'الخبز', plural: 'die Brote', type: 'noun', gender: 'das' },
        { german: 'aufgeweckt', arabic: 'مستيقظ / نَبه', type: 'adjective' },
        { german: 'wachsend', arabic: 'متنامٍ', type: 'adjective' },
        { german: 'fließend', arabic: 'متدفق / بطلاقة', type: 'adjective' },
        { german: 'brennend', arabic: 'مشتعل', type: 'adjective' },
        { german: 'duftend', arabic: 'عطر', type: 'adjective' },
        { german: 'spielend', arabic: 'لاعب', type: 'adjective' },
        { german: 'verbessert', arabic: 'محسّن', type: 'adjective' },
        { german: 'gestoppt', arabic: 'متوقف', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-02-q11', type: 'fill-blank', question: 'أكمل بـ Partizip I: "der ___ Hund" (singen)', answer: 'singende', hint: 'singen → singend → singende' },
          { id: 'b2-02-q12', type: 'multiple-choice', question: 'Partizip II من "öffnen" كصفة:', options: ['öffnend', 'geöffnet', 'öffnen', 'öffne'], answer: 'geöffnet' },
          { id: 'b2-02-q13', type: 'fill-blank', question: '"Das ___ Brot duftet." (مخبوز)', answer: 'gebackene', hint: 'backen → gebacken → gebackene' },
          { id: 'b2-02-q14', type: 'multiple-choice', question: 'Partizip I يُعبّر عن:', options: ['فعل مكتمل', 'فعل جارٍ نشط', 'فعل مبني للمجهول', 'مستقبل'], answer: 'فعل جارٍ نشط' },
          { id: 'b2-02-q15', type: 'matching', question: 'اربط الفعل بـ Partizip I:', pairs: [{ left: 'lesen', right: 'lesend' }, { left: 'schlafen', right: 'schlafend' }, { left: 'lachen', right: 'lachend' }, { left: 'laufen', right: 'laufend' }, { left: 'singen', right: 'singend' }], answer: 'matched' },
          { id: 'b2-02-q16', type: 'drag-drop', question: 'رتّب: "النوافذ المفتوحة تسمح بدخول الهواء"', words: ['Die', 'geöffneten', 'Fenster', 'lassen', 'Luft', 'herein'], answer: 'Die geöffneten Fenster lassen Luft herein' },
          { id: 'b2-02-q17', type: 'speaking', question: 'قل: "الطفل النائم لا يجب إيقاظه"', answer: 'Das schlafende Kind soll man nicht wecken' },
          { id: 'b2-02-q18', type: 'fill-blank', question: 'استمع: "Ein ___ Gesicht ist schön." (Partizip I من lachen)', audioPrompt: 'Ein lachendes Gesicht ist schön.', answer: 'lachendes', hint: 'lachen → lachend → lachendes (das)' },
          { id: 'b2-02-q19', type: 'multiple-choice', question: 'في الكلام اليومي، أيّ Partizip أكثر شيوعاً؟', options: ['Partizip I', 'Partizip II', 'كلاهما', 'لا شيء'], answer: 'Partizip II' },
          { id: 'b2-02-q20', type: 'drag-drop', question: 'رتّب: "الشعب المطلع جيداً يصوّت بحكمة"', words: ['Die', 'gut', 'informierte', 'Bevölkerung', 'wählt', 'klug'], answer: 'Die gut informierte Bevölkerung wählt klug' },
        ],
      },
    },
    // ========================= LESSON 3 =========================
...
- um...zu / damit = الهدف (لأي غاية)`,
      ...
      vocabulary: [
        ...
        { german: 'die Maßnahme', arabic: 'الإجراء', plural: 'die Maßnahmen', type: 'noun', gender: 'die' },
        { german: 'das Vorgehen', arabic: 'الأسلوب', type: 'noun', gender: 'das' },
        { german: 'die Aufgabe', arabic: 'المهمة', plural: 'die Aufgaben', type: 'noun', gender: 'die' },
        { german: 'die Hoffnung', arabic: 'الأمل', plural: 'die Hoffnungen', type: 'noun', gender: 'die' },
        { german: 'die Fähigkeit', arabic: 'القدرة', plural: 'die Fähigkeiten', type: 'noun', gender: 'die' },
        { german: 'sich bemühen', arabic: 'يسعى', type: 'verb' },
        { german: 'umsetzen', arabic: 'يطبّق', type: 'verb' },
        { german: 'sich konzentrieren', arabic: 'يركّز', type: 'verb' },
        { german: 'meistern', arabic: 'يتقن', type: 'verb' },
        { german: 'ehrgeizig', arabic: 'طموح', type: 'adjective' },
        { german: 'entschlossen', arabic: 'حازم', type: 'adjective' },
        { german: 'realistisch', arabic: 'واقعي', type: 'adjective' },
        { german: 'gezielt', arabic: 'موجه / محدد', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-03-q11', type: 'fill-blank', question: 'أكمل: "Ich lerne, ___ die Prüfung zu bestehen." (نفس الفاعل)', answer: 'um', hint: 'um + zu + Inf' },
          { id: 'b2-03-q12', type: 'multiple-choice', question: 'متى نستعمل damit بدل um zu؟', options: ['نفس الفاعل دائماً', 'فاعل مختلف', 'سبب', 'لا فرق'], answer: 'فاعل مختلف' },
          { id: 'b2-03-q13', type: 'fill-blank', question: '"Sie kauft ein Geschenk, ___ ihre Mutter sich freut."', answer: 'damit', hint: 'فاعل مختلف → damit' },
          { id: 'b2-03-q14', type: 'multiple-choice', question: 'في "um zu"، أين الفعل؟', options: ['في البداية', 'في الوسط', 'في النهاية كـ Infinitiv', 'يُحذف'], answer: 'في النهاية كـ Infinitiv' },
          { id: 'b2-03-q15', type: 'matching', question: 'اربط الفعل بالاسم:', pairs: [{ left: 'planen', right: 'der Plan' }, { left: 'erfolgen', right: 'der Erfolg' }, { left: 'sich bemühen', right: 'die Bemühung' }, { left: 'investieren', right: 'die Investition' }, { left: 'ziehen', right: 'das Ziel (verwandt)' }], answer: 'matched' },
          { id: 'b2-03-q16', type: 'drag-drop', question: 'رتّب: "أعمل لأكسب المال"', words: ['Ich', 'arbeite,', 'um', 'Geld', 'zu', 'verdienen'], answer: 'Ich arbeite, um Geld zu verdienen' },
          { id: 'b2-03-q17', type: 'speaking', question: 'قل: "أوفّر لشراء بيت"', answer: 'Ich spare, um ein Haus zu kaufen' },
          { id: 'b2-03-q18', type: 'fill-blank', question: 'استمع: "Er erklärt langsam, ___ wir verstehen." (لكي)', audioPrompt: 'Er erklärt langsam, damit wir verstehen.', answer: 'damit', hint: 'فاعل مختلف' },
          { id: 'b2-03-q19', type: 'multiple-choice', question: 'الفرق بين Final و Kausal:', options: ['الهدف ضد السبب', 'كلاهما سبب', 'كلاهما هدف', 'لا فرق'], answer: 'الهدف ضد السبب' },
          { id: 'b2-03-q20', type: 'drag-drop', question: 'رتّب: "ينبغي أن تتحضّر جيداً لتحقّق هدفك"', words: ['Du', 'solltest', 'dich', 'gut', 'vorbereiten,', 'um', 'dein', 'Ziel', 'zu', 'erreichen'], answer: 'Du solltest dich gut vorbereiten, um dein Ziel zu erreichen' },
        ],
      },
    },
    // ========================= LESSON 4 =========================
...
- Er **muss** krank **gewesen sein**. (لا بد أنه كان مريضاً)`,
      ...
      vocabulary: [
        ...
        { german: 'die Annahme', arabic: 'الفرضية', plural: 'die Annahmen', type: 'noun', gender: 'die' },
        { german: 'der Verdacht', arabic: 'الشبهة', type: 'noun', gender: 'der' },
        { german: 'die Tatsache', arabic: 'الحقيقة', plural: 'die Tatsachen', type: 'noun', gender: 'die' },
        { german: 'die Information', arabic: 'المعلومة', plural: 'die Informationen', type: 'noun', gender: 'die' },
        { german: 'feststellen', arabic: 'يلاحظ / يثبت', type: 'verb' },
        { german: 'einschätzen', arabic: 'يقيّم', type: 'verb' },
        { german: 'schließen auf', arabic: 'يستنتج من', type: 'verb' },
        { german: 'sich vorstellen', arabic: 'يتخيّل', type: 'verb' },
        { german: 'beweisen', arabic: 'يبرهن', type: 'verb' },
        { german: 'glaubhaft', arabic: 'موثوق', type: 'adjective' },
        { german: 'zweifelhaft', arabic: 'مشكوك فيه', type: 'adjective' },
        { german: 'eindeutig', arabic: 'بلا لبس', type: 'adjective' },
        { german: 'fraglich', arabic: 'محل تساؤل', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-04-q11', type: 'fill-blank', question: 'يقين 99%: "Er ___ krank sein." (muss/könnte)', answer: 'muss', hint: 'muss = يقين' },
          { id: 'b2-04-q12', type: 'multiple-choice', question: 'لإشاعة: "Er ___ reich sein."', options: ['muss', 'soll', 'will', 'kann'], answer: 'soll' },
          { id: 'b2-04-q13', type: 'fill-blank', question: 'لادعاء ذاتي: "Er ___ es gesehen haben."', answer: 'will', hint: 'will = يدّعي عن نفسه' },
          { id: 'b2-04-q14', type: 'multiple-choice', question: 'احتمال 60%:', options: ['muss', 'könnte', 'soll', 'will'], answer: 'könnte' },
          { id: 'b2-04-q15', type: 'matching', question: 'اربط الـ Modalverb بمعناه الذاتي:', pairs: [{ left: 'muss', right: 'يقين قوي' }, { left: 'könnte', right: 'احتمال' }, { left: 'soll', right: 'إشاعة' }, { left: 'will', right: 'ادعاء ذاتي' }, { left: 'dürfte', right: 'احتمال قوي' }], answer: 'matched' },
          { id: 'b2-04-q16', type: 'drag-drop', question: 'رتّب: "لا بد أنه نسي الموعد"', words: ['Er', 'muss', 'den', 'Termin', 'vergessen', 'haben'], answer: 'Er muss den Termin vergessen haben' },
          { id: 'b2-04-q17', type: 'speaking', question: 'قل: "يبدو أنه مريض" (scheinen + zu)', answer: 'Er scheint krank zu sein' },
          { id: 'b2-04-q18', type: 'fill-blank', question: 'استمع: "Es ___ heute regnen." (احتمال — dürfte)', audioPrompt: 'Es dürfte heute regnen.', answer: 'dürfte', hint: 'dürfte = احتمال قوي' },
          { id: 'b2-04-q19', type: 'multiple-choice', question: 'في الأخبار للإشاعة:', options: ['muss', 'soll', 'kann', 'darf'], answer: 'soll' },
          { id: 'b2-04-q20', type: 'drag-drop', question: 'رتّب: "ربما يأتي غداً"', words: ['Er', 'könnte', 'morgen', 'kommen'], answer: 'Er könnte morgen kommen' },
        ],
      },
    },
    // ========================= LESSON 5 =========================
...
- Das Auto **ist zu reparieren**. = kann/muss repariert werden`,
      ...
      vocabulary: [
        ...
        { german: 'die Genehmigung', arabic: 'الترخيص', plural: 'die Genehmigungen', type: 'noun', gender: 'die' },
        { german: 'die Verpflichtung', arabic: 'الالتزام', plural: 'die Verpflichtungen', type: 'noun', gender: 'die' },
        { german: 'die Anforderung', arabic: 'المتطلَّب', plural: 'die Anforderungen', type: 'noun', gender: 'die' },
        { german: 'der Antrag', arabic: 'الطلب الرسمي', plural: 'die Anträge', type: 'noun', gender: 'der' },
        { german: 'die Unterlagen', arabic: 'المستندات', type: 'noun', gender: 'pl' },
        { german: 'genehmigen', arabic: 'يرخّص', type: 'verb' },
        { german: 'unterzeichnen', arabic: 'يوقّع', type: 'verb' },
        { german: 'beantragen', arabic: 'يقدّم طلباً', type: 'verb' },
        { german: 'einreichen', arabic: 'يُقدِّم (وثيقة)', type: 'verb' },
        { german: 'realisierbar', arabic: 'قابل للتنفيذ', type: 'adjective' },
        { german: 'verfügbar', arabic: 'متاح', type: 'adjective' },
        { german: 'optional', arabic: 'اختياري', type: 'adjective' },
        { german: 'verpflichtend', arabic: 'إلزامي', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-05-q11', type: 'fill-blank', question: 'أكمل: "Das Formular muss ___ werden." (Partizip II من ausfüllen)', answer: 'ausgefüllt', hint: 'ausfüllen → ausgefüllt' },
          { id: 'b2-05-q12', type: 'multiple-choice', question: 'بنية Passiv + Modalverb:', options: ['Modal + werden + PII', 'Modal + PII + werden', 'werden + Modal + PII', 'PII + Modal + werden'], answer: 'Modal + PII + werden' },
          { id: 'b2-05-q13', type: 'fill-blank', question: '"Das Auto ___ zu reparieren." (sein-Konstruktion = muss/kann)', answer: 'ist', hint: 'sein + zu + Inf' },
          { id: 'b2-05-q14', type: 'multiple-choice', question: 'المقصود بـ "Das ist machbar":', options: ['mussbar', 'kann gemacht werden', 'wird gemacht', 'gemacht'], answer: 'kann gemacht werden' },
          { id: 'b2-05-q15', type: 'matching', question: 'اربط الصفة بالمعنى Passiv:', pairs: [{ left: 'lesbar', right: 'kann gelesen werden' }, { left: 'essbar', right: 'kann gegessen werden' }, { left: 'lösbar', right: 'kann gelöst werden' }, { left: 'machbar', right: 'kann gemacht werden' }], answer: 'matched' },
          { id: 'b2-05-q16', type: 'drag-drop', question: 'رتّب: "يجب توقيع الطلب فوراً"', words: ['Der', 'Antrag', 'muss', 'sofort', 'unterzeichnet', 'werden'], answer: 'Der Antrag muss sofort unterzeichnet werden' },
          { id: 'b2-05-q17', type: 'speaking', question: 'قل: "هذا يمكن حله بسهولة"', answer: 'Das lässt sich leicht lösen' },
          { id: 'b2-05-q18', type: 'fill-blank', question: 'استمع: "Die Regeln müssen ___ werden." (befolgt)', audioPrompt: 'Die Regeln müssen befolgt werden.', answer: 'befolgt', hint: 'befolgen → befolgt' },
          { id: 'b2-05-q19', type: 'multiple-choice', question: 'في القوانين الرسمية، الصيغة الأكثر استعمالاً:', options: ['Aktiv', 'Passiv + Modalverb', 'Imperativ', 'Konjunktiv'], answer: 'Passiv + Modalverb' },
          { id: 'b2-05-q20', type: 'drag-drop', question: 'رتّب (sein + zu): "هذا يجب مراعاته"', words: ['Das', 'ist', 'zu', 'beachten'], answer: 'Das ist zu beachten' },
        ],
      },
    },
    // ========================= LESSON 6 =========================
...
- Ich denke **an ihn**. (أفكر فيه - شخص)`,
      ...
      vocabulary: [
        ...
        { german: 'sich beschäftigen mit', arabic: 'ينشغل بـ', type: 'verb' },
        { german: 'sich beschweren über', arabic: 'يشكو من', type: 'verb' },
        { german: 'sich konzentrieren auf', arabic: 'يركّز على', type: 'verb' },
        { german: 'sich verlassen auf', arabic: 'يعتمد على', type: 'verb' },
        { german: 'reagieren auf', arabic: 'يردّ على', type: 'verb' },
        { german: 'überzeugen von', arabic: 'يقنع بـ', type: 'verb' },
        { german: 'streben nach', arabic: 'يسعى إلى', type: 'verb' },
        { german: 'leiden unter', arabic: 'يعاني من', type: 'verb' },
        { german: 'protestieren gegen', arabic: 'يحتج على', type: 'verb' },
        { german: 'kämpfen für', arabic: 'يناضل من أجل', type: 'verb' },
        { german: 'sich gewöhnen an', arabic: 'يعتاد على', type: 'verb' },
        { german: 'rechnen mit', arabic: 'يتوقّع', type: 'verb' },
        { german: 'sich bedanken für', arabic: 'يشكر على', type: 'verb' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-06-q11', type: 'fill-blank', question: 'أكمل: "Ich verlasse mich ___ dich." (auf + Akk)', answer: 'auf', hint: 'sich verlassen + auf + Akk' },
          { id: 'b2-06-q12', type: 'multiple-choice', question: 'فعل "leiden" يأخذ:', options: ['unter + Dat', 'auf + Akk', 'an + Dat', 'für + Akk'], answer: 'unter + Dat' },
          { id: 'b2-06-q13', type: 'fill-blank', question: '"Wofür interessierst du dich?" — السؤال يبدأ بـ ___', answer: 'Wofür', hint: 'wo + für (شيء)' },
          { id: 'b2-06-q14', type: 'multiple-choice', question: 'لشخص نقول "ich denke an + ihn"، لشيء نقول:', options: ['daran', 'darauf', 'damit', 'dafür'], answer: 'daran' },
          { id: 'b2-06-q15', type: 'matching', question: 'اربط الفعل بحرف جره:', pairs: [{ left: 'sich beschweren', right: 'über + Akk' }, { left: 'rechnen', right: 'mit + Dat' }, { left: 'protestieren', right: 'gegen + Akk' }, { left: 'kämpfen', right: 'für + Akk' }, { left: 'sich gewöhnen', right: 'an + Akk' }], answer: 'matched' },
          { id: 'b2-06-q16', type: 'drag-drop', question: 'رتّب: "أعتمد عليك في كل شيء"', words: ['Ich', 'verlasse', 'mich', 'in', 'allem', 'auf', 'dich'], answer: 'Ich verlasse mich in allem auf dich' },
          { id: 'b2-06-q17', type: 'speaking', question: 'قل: "أعاني من الإجهاد"', answer: 'Ich leide unter Stress' },
          { id: 'b2-06-q18', type: 'fill-blank', question: 'استمع: "Ich bedanke mich ___ deine Hilfe." (für)', audioPrompt: 'Ich bedanke mich für deine Hilfe.', answer: 'für', hint: 'sich bedanken + für + Akk' },
          { id: 'b2-06-q19', type: 'multiple-choice', question: 'wo-Komposita تستخدم لـ:', options: ['الأشخاص', 'الأشياء فقط', 'الأماكن فقط', 'الأزمنة'], answer: 'الأشياء فقط' },
          { id: 'b2-06-q20', type: 'drag-drop', question: 'رتّب: "أركّز على دراستي"', words: ['Ich', 'konzentriere', 'mich', 'auf', 'mein', 'Studium'], answer: 'Ich konzentriere mich auf mein Studium' },
        ],
      },
    },
    // ========================= LESSON 7 =========================
...
⚠️ هذه الصفات تُستعمل عادةً مع **sein**: Ich bin stolz auf dich.`,
      ...
      vocabulary: [
        ...
        { german: 'wütend', arabic: 'غاضب', type: 'adjective' },
        { german: 'sicher', arabic: 'متأكد / آمن', type: 'adjective' },
        { german: 'unsicher', arabic: 'غير متأكد', type: 'adjective' },
        { german: 'erstaunt', arabic: 'مندهش', type: 'adjective' },
        { german: 'enttäuscht', arabic: 'محبط', type: 'adjective' },
        { german: 'überzeugt', arabic: 'مقتنع', type: 'adjective' },
        { german: 'gespannt', arabic: 'متشوّق', type: 'adjective' },
        { german: 'eifrig', arabic: 'حريص', type: 'adjective' },
        { german: 'neidisch', arabic: 'حاسد', type: 'adjective' },
        { german: 'höflich', arabic: 'مهذّب', type: 'adjective' },
        { german: 'unhöflich', arabic: 'غير مهذّب', type: 'adjective' },
      ...
      exercise: {
        questions: [
          ...
          { id: 'b2-07-q11', type: 'fill-blank', question: '"Ich bin überzeugt ___ deinem Erfolg." (von + Dat)', answer: 'von', hint: 'überzeugt von' },
          { id: 'b2-07-q12', type: 'multiple-choice', question: '"Ich bin abhängig ___ Internet."', options: ['für', 'mit', 'von', 'auf'], answer: 'von' },
          { id: 'b2-07-q13', type: 'fill-blank', question: '"Sie ist eifersüchtig ___ ihre Schwester." (auf + Akk)', answer: 'auf', hint: 'eifersüchtig auf' },
          { id: 'b2-07-q14', type: 'multiple-choice', question: '"interessiert" يأخذ:', options: ['für + Akk', 'an + Dat', 'auf + Akk', 'in + Akk'], answer: 'an + Dat' },
          { id: 'b2-07-q15', type: 'matching', question: 'اربط الصفة بحرف جرها:', pairs: [{ left: 'stolz', right: 'auf + Akk' }, { left: 'zufrieden', right: 'mit + Dat' }, { left: 'verantwortlich', right: 'für + Akk' }, { left: 'abhängig', right: 'von + Dat' }, { left: 'interessiert', right: 'an + Dat' }], answer: 'matched' },
          { id: 'b2-07-q16', type: 'drag-drop', question: 'رتّب: "أنا ممتن جداً لمساعدتك"', words: ['Ich', 'bin', 'sehr', 'dankbar', 'für', 'deine', 'Hilfe'], answer: 'Ich bin sehr dankbar für deine Hilfe' },
          { id: 'b2-07-q17', type: 'speaking', question: 'قل: "أنا فخور بشعبي"', answer: 'Ich bin stolz auf mein Volk' },
          { id: 'b2-07-q18', type: 'fill-blank', question: 'استمع: "Wir sind reich ___ Kultur." (an + Dat)', audioPrompt: 'Wir sind reich an Kultur.', answer: 'an', hint: 'reich an + Dat' },
          { id: 'b2-07-q19', type: 'multiple-choice', question: '"bereit" يأخذ:', options: ['für + Akk', 'zu + Dat', 'mit + Dat', 'auf + Akk'], answer: 'zu + Dat' },
          { id: 'b2-07-q20', type: 'drag-drop', question: 'رتّب: "هي مشتاقة لرؤيتك"', words: ['Sie', 'ist', 'gespannt', 'darauf,', 'dich', 'zu', 'sehen'], answer: 'Sie ist gespannt darauf, dich zu sehen' },
        ],
      },
    },
    // ========================= LESSON 8 =========================
...
⚠️ **je + مقارن** → **desto/umso + مقارن** (بالترتيب)`,
      ...
      vocabulary: [
        ...
        { german: 'außerdem', arabic: 'علاوة على ذلك', type: 'adverb' },
        { german: 'darüber hinaus', arabic: 'فضلاً عن ذلك', type: 'phrase' },
        { german: 'demzufolge', arabic: 'وفقاً لذلك', type: 'adverb' },
        { german: 'infolgedessen', arabic: 'نتيجة لذلك', type: 'adverb' },
        { german: 'zwar', arabic: 'صحيح أن', type: 'adverb' },
        { german: 'kaum', arabic: 'بالكاد', type: 'adverb' },
        { german: 'falls', arabic: 'في حال', type: 'conjunction' },
        { german: 'sobald wie möglich', arabic: 'في أقرب وقت ممكن', type: 'phrase' },
        { german: 'zugleich', arabic: 'في الوقت نفسه', type: 'adverb' },
        { german: 'überdies', arabic: 'فضلاً عن ذلك', type: 'adverb' },
        { german: 'ferner', arabic: 'علاوة على ذلك', type: 'adverb' },
        { german: 'gleichzeitig', arabic: 'في الوقت ذاته', type: 'adverb' },
        { german: 'offensichtlich', arabic: 'من الواضح', type: 'adverb' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-08-q11', type: 'fill-blank', question: 'أكمل: "Je mehr du übst, ___ besser wirst du."', answer: 'desto', hint: 'je ... desto' },
          { id: 'b2-08-q12', type: 'multiple-choice', question: 'بعد "als ob" ما الفعل المطلوب؟', options: ['Indikativ', 'Konjunktiv I', 'Konjunktiv II', 'Imperativ'], answer: 'Konjunktiv II' },
          { id: 'b2-08-q13', type: 'fill-blank', question: '"Ich lerne, ___ ich jeden Tag lese." (عن طريق)', answer: 'indem', hint: 'indem = الوسيلة' },
          { id: 'b2-08-q14', type: 'multiple-choice', question: '"sodass" يعبّر عن:', options: ['سبب', 'هدف', 'نتيجة', 'شرط'], answer: 'نتيجة' },
          { id: 'b2-08-q15', type: 'matching', question: 'اربط Konnektor بمعناه:', pairs: [{ left: 'sodass', right: 'نتيجة' }, { left: 'je...desto', right: 'مقارنة متوازنة' }, { left: 'indem', right: 'وسيلة' }, { left: 'als ob', right: 'كما لو' }, { left: 'anstatt zu', right: 'بديل' }], answer: 'matched' },
          { id: 'b2-08-q16', type: 'drag-drop', question: 'رتّب: "كلما تعلمت أكثر، أصبحت أكثر ثقة"', words: ['Je', 'mehr', 'ich', 'lerne,', 'desto', 'sicherer', 'werde', 'ich'], answer: 'Je mehr ich lerne, desto sicherer werde ich' },
          { id: 'b2-08-q17', type: 'speaking', question: 'قل: "ذهب دون أن يقول كلمة"', answer: 'Er ging, ohne ein Wort zu sagen' },
          { id: 'b2-08-q18', type: 'fill-blank', question: 'استمع: "Er tut, ___ ob er reich wäre." (Konnektor)', audioPrompt: 'Er tut, als ob er reich wäre.', answer: 'als', hint: 'als ob + Konjunktiv II' },
          { id: 'b2-08-q19', type: 'multiple-choice', question: 'في "anstatt + zu + Inf"، أين الفعل؟', options: ['في البداية', 'في الوسط', 'في النهاية كـ Infinitiv', 'مُصرَّف'], answer: 'في النهاية كـ Infinitiv' },
          { id: 'b2-08-q20', type: 'drag-drop', question: 'رتّب: "تمطر بقوة، لذلك نبقى في البيت"', words: ['Es', 'regnet', 'stark,', 'sodass', 'wir', 'zu', 'Hause', 'bleiben'], answer: 'Es regnet stark, sodass wir zu Hause bleiben' },
        ],
      },
    },
    // ========================= LESSON 9 =========================
...
⚠️ القواعد المهمة: Konjunktiv II للأدب، Passiv، Nominalstil.`,
      ...
      vocabulary: [
        ...
        { german: 'der Arbeitsplatz', arabic: 'مكان العمل', plural: 'die Arbeitsplätze', type: 'noun', gender: 'der' },
        { german: 'die Karriere', arabic: 'المسار المهني', plural: 'die Karrieren', type: 'noun', gender: 'die' },
        { german: 'die Weiterbildung', arabic: 'التدريب المستمر', plural: 'die Weiterbildungen', type: 'noun', gender: 'die' },
        { german: 'das Gehalt', arabic: 'الراتب', plural: 'die Gehälter', type: 'noun', gender: 'das' },
        { german: 'der Vorgesetzte', arabic: 'الرئيس المباشر', plural: 'die Vorgesetzten', type: 'noun', gender: 'der' },
        { german: 'die Pünktlichkeit', arabic: 'الالتزام بالمواعيد', type: 'noun', gender: 'die' },
        { german: 'die Effizienz', arabic: 'الكفاءة', type: 'noun', gender: 'die' },
        { german: 'der Stress', arabic: 'الإجهاد', type: 'noun', gender: 'der' },
        { german: 'überzeugen', arabic: 'يقنع', type: 'verb' },
        { german: 'sich engagieren', arabic: 'يلتزم', type: 'verb' },
        { german: 'lösen', arabic: 'يحل', type: 'verb' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-09-q11', type: 'fill-blank', question: '"Sie hat sich ___ eine Stelle beworben." (um)', answer: 'um', hint: 'sich bewerben um + Akk' },
          { id: 'b2-09-q12', type: 'multiple-choice', question: 'ما معنى "die Beförderung"؟', options: ['الاستقالة', 'التوظيف', 'الترقية', 'الراتب'], answer: 'الترقية' },
          { id: 'b2-09-q13', type: 'fill-blank', question: '"Wir haben einen ___ erreicht." (تسوية)', answer: 'Kompromiss', hint: 'der Kompromiss' },
          { id: 'b2-09-q14', type: 'multiple-choice', question: 'الفرق بين "kündigen" و "entlassen":', options: ['نفس الشيء', 'kündigen = الموظف يستقيل، entlassen = صاحب العمل يفصل', 'العكس', 'لا فرق'], answer: 'kündigen = الموظف يستقيل، entlassen = صاحب العمل يفصل' },
          { id: 'b2-09-q15', type: 'matching', question: 'اربط مصطلح العمل بمعناه:', pairs: [{ left: 'die Besprechung', right: 'الاجتماع' }, { left: 'die Beförderung', right: 'الترقية' }, { left: 'die Kündigung', right: 'الاستقالة' }, { left: 'der Vorgesetzte', right: 'الرئيس المباشر' }, { left: 'die Weiterbildung', right: 'التدريب المستمر' }], answer: 'matched' },
          { id: 'b2-09-q16', type: 'drag-drop', question: 'رتّب: "أريد مناقشة زيادة الراتب"', words: ['Ich', 'möchte', 'eine', 'Gehaltserhöhung', 'besprechen'], answer: 'Ich möchte eine Gehaltserhöhung besprechen' },
          { id: 'b2-09-q17', type: 'speaking', question: 'قل: "العمل الجماعي مهم جداً للنجاح"', answer: 'Teamarbeit ist sehr wichtig für den Erfolg' },
          { id: 'b2-09-q18', type: 'fill-blank', question: 'استمع: "Wir müssen die ___ einhalten." (الموعد النهائي)', audioPrompt: 'Wir müssen die Deadline einhalten.', answer: 'Deadline', hint: 'die Deadline / der Termin' },
          { id: 'b2-09-q19', type: 'multiple-choice', question: 'في خطاب تقديم رسمي، الافتتاحية:', options: ['Hallo!', 'Hi!', 'Sehr geehrte Damen und Herren,', 'Liebe Freunde'], answer: 'Sehr geehrte Damen und Herren,' },
          { id: 'b2-09-q20', type: 'drag-drop', question: 'رتّب: "حسب تقييمي، هذا مشروع ناجح"', words: ['Meiner', 'Einschätzung', 'nach', 'ist', 'das', 'ein', 'erfolgreiches', 'Projekt'], answer: 'Meiner Einschätzung nach ist das ein erfolgreiches Projekt' },
        ],
      },
    },
    // ========================= LESSON 10 =========================
...
**القواعد المهمة:** Passiv (التعليمات)، Konjunktiv II (الأدب)، Nominalstil.`,
      ...
      vocabulary: [
        ...
        { german: 'die Mensa', arabic: 'مطعم الجامعة', plural: 'die Mensen', type: 'noun', gender: 'die' },
        { german: 'die Bibliothek', arabic: 'المكتبة', plural: 'die Bibliotheken', type: 'noun', gender: 'die' },
        { german: 'der Hörsaal', arabic: 'القاعة', plural: 'die Hörsäle', type: 'noun', gender: 'der' },
        { german: 'der Studiengang', arabic: 'البرنامج الدراسي', plural: 'die Studiengänge', type: 'noun', gender: 'der' },
        { german: 'die Note', arabic: 'الدرجة', plural: 'die Noten', type: 'noun', gender: 'die' },
        { german: 'das Wissen', arabic: 'المعرفة', type: 'noun', gender: 'das' },
        { german: 'die Forschung', arabic: 'البحث العلمي', plural: 'die Forschungen', type: 'noun', gender: 'die' },
        { german: 'die Doktorarbeit', arabic: 'أطروحة الدكتوراه', type: 'noun', gender: 'die' },
        { german: 'die Promotion', arabic: 'مرحلة الدكتوراه', type: 'noun', gender: 'die' },
        { german: 'forschen', arabic: 'يبحث علمياً', type: 'verb' },
        { german: 'verfassen', arabic: 'يحرّر', type: 'verb' },
        { german: 'recherchieren', arabic: 'ينقّب علمياً', type: 'verb' },
        { german: 'akademisch', arabic: 'أكاديمي', type: 'adjective' },
        { german: 'theoretisch', arabic: 'نظري', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-10-q11', type: 'fill-blank', question: '"Ich ___ mich an der Uni ein." (سجّلت)', answer: 'schreibe', hint: 'sich einschreiben قابل للانفصال' },
          { id: 'b2-10-q12', type: 'multiple-choice', question: 'ما الفرق بين Vorlesung و Seminar؟', options: ['نفس الشيء', 'Vorlesung نظرية كبيرة، Seminar تطبيقي صغير', 'Vorlesung كتابة فقط', 'Seminar فقط لطلاب الدكتوراه'], answer: 'Vorlesung نظرية كبيرة، Seminar تطبيقي صغير' },
          { id: 'b2-10-q13', type: 'fill-blank', question: '"Ich bewerbe mich ___ ein Stipendium." (لـ)', answer: 'für', hint: 'sich bewerben für' },
          { id: 'b2-10-q14', type: 'multiple-choice', question: 'البكالوريوس بالألمانية:', options: ['der Master', 'das Bachelor', 'der Bachelor', 'die Promotion'], answer: 'der Bachelor' },
          { id: 'b2-10-q15', type: 'matching', question: 'اربط المرحلة بالمدة:', pairs: [{ left: 'Bachelor', right: '3 سنوات' }, { left: 'Master', right: '2 سنة' }, { left: 'Promotion', right: '3-5 سنوات' }, { left: 'Abitur', right: 'نهاية الثانوية' }], answer: 'matched' },
          { id: 'b2-10-q16', type: 'drag-drop', question: 'رتّب: "أكتب رسالة الماستر عن الذكاء الاصطناعي"', words: ['Ich', 'schreibe', 'meine', 'Masterarbeit', 'über', 'KI'], answer: 'Ich schreibe meine Masterarbeit über KI' },
          { id: 'b2-10-q17', type: 'speaking', question: 'قل: "أدرس علوم الحاسوب في جامعة برلين"', answer: 'Ich studiere Informatik an der Universität Berlin' },
          { id: 'b2-10-q18', type: 'fill-blank', question: 'استمع: "Ich lege eine ___ ab." (أؤدي امتحاناً)', audioPrompt: 'Ich lege eine Prüfung ab.', answer: 'Prüfung', hint: 'eine Prüfung ablegen' },
          { id: 'b2-10-q19', type: 'multiple-choice', question: 'ما هو DAAD؟', options: ['نوع امتحان', 'منحة دراسية ألمانية', 'برنامج دكتوراه', 'كلية معينة'], answer: 'منحة دراسية ألمانية' },
          { id: 'b2-10-q20', type: 'drag-drop', question: 'رتّب: "بعد البكالوريوس سأدرس ماستر"', words: ['Nach', 'dem', 'Bachelor', 'mache', 'ich', 'einen', 'Master'], answer: 'Nach dem Bachelor mache ich einen Master' },
        ],
      },
    },
    // ========================= LESSON 11 =========================
...
- "Meiner Meinung nach..."`,
      ...
      vocabulary: [
        ...
        { german: 'der Vorteil', arabic: 'الميزة', plural: 'die Vorteile', type: 'noun', gender: 'der' },
        { german: 'der Nachteil', arabic: 'العيب', plural: 'die Nachteile', type: 'noun', gender: 'der' },
        { german: 'die Stellungnahme', arabic: 'الموقف', plural: 'die Stellungnahmen', type: 'noun', gender: 'die' },
        { german: 'der Beweis', arabic: 'الدليل', plural: 'die Beweise', type: 'noun', gender: 'der' },
        { german: 'das Beispiel', arabic: 'المثال', plural: 'die Beispiele', type: 'noun', gender: 'das' },
        { german: 'die Einleitung', arabic: 'المقدمة', type: 'noun', gender: 'die' },
        { german: 'der Schluss', arabic: 'الخاتمة', type: 'noun', gender: 'der' },
        { german: 'einleiten', arabic: 'يفتتح', type: 'verb' },
        { german: 'zusammenfassen', arabic: 'يلخّص', type: 'verb' },
        { german: 'argumentieren', arabic: 'يحاجّ', type: 'verb' },
        { german: 'gegenüberstellen', arabic: 'يقارن', type: 'verb' },
        { german: 'sachlich', arabic: 'موضوعي', type: 'adjective' },
        { german: 'objektiv', arabic: 'موضوعي / محايد', type: 'adjective' },
        { german: 'subjektiv', arabic: 'ذاتي', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-11-q11', type: 'fill-blank', question: 'أكمل: "___ Gegensatz zu seiner Meinung..."', answer: 'Im', hint: 'im Gegensatz zu' },
          { id: 'b2-11-q12', type: 'multiple-choice', question: 'ما ضد "der Vorteil"؟', options: ['der Nachteil', 'der Schaden', 'der Schluss', 'der Standpunkt'], answer: 'der Nachteil' },
          { id: 'b2-11-q13', type: 'fill-blank', question: '"Ich kann diese These nur ___." (befürworten)', answer: 'befürworten', hint: 'يؤيّد' },
          { id: 'b2-11-q14', type: 'multiple-choice', question: 'بنية الحجة الجيدة:', options: ['مقدمة + أمثلة', 'These + Argumente + Schluss', 'كتلة واحدة', 'فقط أمثلة'], answer: 'These + Argumente + Schluss' },
          { id: 'b2-11-q15', type: 'matching', question: 'اربط العبارة بوظيفتها:', pairs: [{ left: 'Meiner Meinung nach', right: 'تقديم رأي' }, { left: 'Außerdem', right: 'إضافة حجة' }, { left: 'Allerdings', right: 'حجة مضادة' }, { left: 'Zum Beispiel', right: 'مثال' }, { left: 'Zusammenfassend', right: 'خاتمة' }], answer: 'matched' },
          { id: 'b2-11-q16', type: 'drag-drop', question: 'رتّب: "أنا مقتنع تماماً بأن البيئة هي الأهم"', words: ['Ich', 'bin', 'der', 'festen', 'Überzeugung,', 'dass', 'die', 'Umwelt', 'das', 'Wichtigste', 'ist'], answer: 'Ich bin der festen Überzeugung, dass die Umwelt das Wichtigste ist' },
          { id: 'b2-11-q17', type: 'speaking', question: 'قل: "من ناحية أخرى، هذا غالٍ"', answer: 'Andererseits ist das teuer' },
          { id: 'b2-11-q18', type: 'fill-blank', question: 'استمع: "___ kann man sagen, dass..." (zusammenfassend)', audioPrompt: 'Zusammenfassend kann man sagen, dass...', answer: 'Zusammenfassend', hint: 'في الخاتمة' },
          { id: 'b2-11-q19', type: 'multiple-choice', question: 'في كتابة Goethe B2، طول التعليق:', options: ['50 كلمة', '150 كلمة', '500 كلمة', '1000 كلمة'], answer: '150 كلمة' },
          { id: 'b2-11-q20', type: 'drag-drop', question: 'رتّب: "علاوة على ذلك، يقدّم هذا فرصاً جديدة"', words: ['Darüber', 'hinaus', 'bietet', 'das', 'neue', 'Möglichkeiten'], answer: 'Darüber hinaus bietet das neue Möglichkeiten' },
        ],
      },
    },
    // ========================= LESSON 12 =========================
...
- تكلم مع ناطقين أصليين أسبوعياً (Tandem)`,
      ...
      vocabulary: [
        ...
        { german: 'die Bestätigung', arabic: 'التأكيد', plural: 'die Bestätigungen', type: 'noun', gender: 'die' },
        { german: 'die Anstrengung', arabic: 'الجهد', plural: 'die Anstrengungen', type: 'noun', gender: 'die' },
        { german: 'die Übung', arabic: 'التمرين', plural: 'die Übungen', type: 'noun', gender: 'die' },
        { german: 'das Hörverständnis', arabic: 'فهم المسموع', type: 'noun', gender: 'das' },
        { german: 'das Leseverständnis', arabic: 'فهم المقروء', type: 'noun', gender: 'das' },
        { german: 'die Aussprache', arabic: 'النطق', type: 'noun', gender: 'die' },
        { german: 'die Wortwahl', arabic: 'اختيار الكلمات', type: 'noun', gender: 'die' },
        { german: 'der Zusammenhang', arabic: 'السياق', plural: 'die Zusammenhänge', type: 'noun', gender: 'der' },
        { german: 'erweitern', arabic: 'يوسّع', type: 'verb' },
        { german: 'üben', arabic: 'يتدرّب', type: 'verb' },
        { german: 'meistern', arabic: 'يتقن', type: 'verb' },
        { german: 'sich messen', arabic: 'يقارن نفسه', type: 'verb' },
        { german: 'systematisch', arabic: 'منهجي', type: 'adjective' },
      ],
      exercise: {
        questions: [
          ...
          { id: 'b2-12-q11', type: 'fill-blank', question: 'أكمل: "Ich muss meine Aussprache ___." (verbessern)', answer: 'verbessern', hint: 'يحسّن' },
          { id: 'b2-12-q12', type: 'multiple-choice', question: 'كم قسم في امتحان Goethe-Zertifikat B2؟', options: ['2', '3', '4 (Lesen, Hören, Schreiben, Sprechen)', '5'], answer: '4 (Lesen, Hören, Schreiben, Sprechen)' },
          { id: 'b2-12-q13', type: 'fill-blank', question: '"Bildung ist der ___ zum Erfolg." (المفتاح)', answer: 'Schlüssel', hint: 'der Schlüssel' },
          { id: 'b2-12-q14', type: 'multiple-choice', question: 'بعد B2:', options: ['الرجوع لـ A1', 'الانتقال لـ C1', 'فقط القراءة', 'لا شيء'], answer: 'الانتقال لـ C1' },
          { id: 'b2-12-q15', type: 'matching', question: 'اربط القاعدة بمثالها:', pairs: [{ left: 'Nominalstil', right: 'das Lernen' }, { left: 'Partizipialattribut', right: 'der lesende Mann' }, { left: 'Passiv + Modal', right: 'muss gemacht werden' }, { left: 'je...desto', right: 'Je mehr, desto besser' }, { left: 'als ob + Konj II', right: 'als ob er krank wäre' }], answer: 'matched' },
          { id: 'b2-12-q16', type: 'drag-drop', question: 'رتّب: "نجحت في B2 لأنني تدرّبت بانتظام"', words: ['Ich', 'habe', 'B2', 'bestanden,', 'weil', 'ich', 'regelmäßig', 'geübt', 'habe'], answer: 'Ich habe B2 bestanden, weil ich regelmäßig geübt habe' },
          { id: 'b2-12-q17', type: 'speaking', question: 'قل: "أنا فخور بمستواي في الألمانية"', answer: 'Ich bin stolz auf mein Deutsch-Niveau' },
          { id: 'b2-12-q18', type: 'fill-blank', question: 'استمع: "Mein Wortschatz ___ sich täglich." (يتوسع)', audioPrompt: 'Mein Wortschatz erweitert sich täglich.', answer: 'erweitert', hint: 'sich erweitern' },
          { id: 'b2-12-q19', type: 'multiple-choice', question: 'المستوى B2 يكفي لـ:', options: ['زيارة قصيرة فقط', 'الدراسة الجامعية والعمل', 'الترجمة الفورية', 'الحاضرات الأكاديمية المعقدة'], answer: 'الدراسة الجامعية والعمل' },
          { id: 'b2-12-q20', type: 'drag-drop', question: 'رتّب: "تهانينا، لقد أنجزت B2"', words: ['Glückwunsch!', 'Du', 'hast', 'B2', 'geschafft'], answer: 'Glückwunsch! Du hast B2 geschafft' },
        ],
      },
    },
    // ─────────────────────────────────────────────
