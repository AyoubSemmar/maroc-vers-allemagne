...
- احفظ 30 عبارة نقاش جاهزة`,
    ...
    // ─────────────────────────────────────────────
    {
      ...
      grammar: {
        ...
        content: `الألمانية تبني المستقبل بفعل **werden** (يصبح) + الفعل الرئيسي. **Futur I** = werden + Infinitiv ("سـ + فعل"). **Futur II** = werden + Partizip + haben/sein ("سيكون قد..."). في الكلام اليومي، الناطقون يفضّلون Präsens مع ظرف زمني (morgen, bald) — أبسط.\n\n→ Ich **werde** morgen nach Berlin **fahren**. (سأسافر إلى برلين غداً)\n\nاستعمل Futur I حين تريد التأكيد على المستقبل، الوعد، أو التنبّؤ.`,
        tables: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      grammar: {
        ...
        content: `بعض الأفعال الألمانية لا تكتمل دون حرف جر محدّد بعدها — وهذا الزواج بين الفعل وحرف الجر **لا يطابق دائماً العربية**. يجب حفظها كأزواج.\n\n→ Ich denke **an** dich. (أفكر فيك — ليس "auf dich")\n→ Ich warte **auf** den Bus. (أنتظر الحافلة — ليس "für den Bus")\n\n**كل حرف جر يحدّد الحالة:** an/auf/in/über → Akkusativ مع هذه الأفعال؛ mit/von/zu/bei/nach → Dativ دائماً.`,
        tables: [
