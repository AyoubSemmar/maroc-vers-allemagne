...
const EN = {
  ...
  enrolledNote: 'Seat reserved. To confirm it, arrange the 300 MAD/month payment with us — unpaid seats are released.',
...
const FR: ClassesStrings = {
  ...
  enrolledNote: 'Place réservée. Pour la confirmer, organisez le paiement de 300 DH/mois avec nous — les places non payées sont libérées.',
...
const AR: ClassesStrings = {
  ...
  enrolledNote: 'تم حجز المقعد. لتأكيده، نسّق معنا دفع 300 درهم/شهر — المقاعد غير المدفوعة تُحرَّر.',
...
const DE: ClassesStrings = {
  ...
  enrolledNote: 'Platz reserviert. Zum Bestätigen die Zahlung von 300 MAD/Monat mit uns abstimmen — unbezahlte Plätze werden freigegeben.',
