...
const EN = {
  ...
  payNote: 'Payment is arranged off-site after you reserve (300 MAD/month).',
  enrolledNote: 'Seat reserved! You will receive the payment instructions (300 MAD/month) on WhatsApp. Unpaid seats are released.',
...
const FR: ClassesStrings = {
  ...
  payNote: 'Le paiement se fait hors site après réservation (300 DH/mois).',
  enrolledNote: 'Place réservée ! Vous recevrez les instructions de paiement (300 DH/mois) par WhatsApp. Les places non payées sont libérées.',
...
const AR: ClassesStrings = {
  ...
  payNote: 'يتم الدفع خارج الموقع بعد الحجز (300 درهم/شهر).',
  enrolledNote: 'تم حجز المقعد! ستصلك تعليمات الدفع (300 درهم/شهر) عبر واتساب. المقاعد غير المدفوعة تُحرَّر.',
...
const DE: ClassesStrings = {
  ...
  payNote: 'Die Zahlung erfolgt nach der Reservierung außerhalb der Website (300 MAD/Monat).',
  enrolledNote: 'Platz reserviert! Die Zahlungsanweisungen (300 MAD/Monat) erhältst du per WhatsApp. Unbezahlte Plätze werden freigegeben.',
