...
- 600–900 words for the Arabic content (markdown allowed: headings ##, lists, **bold**).
...
Return ONLY a JSON object, no commentary:
{
  ...
  "content": "Arabic markdown body, 600-900 words",
  "faqs": [{"q":"...","a":"..."}, ...],
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // AR-only keeps this call comfortably under 30s. Translations are
    // generated by /api/admin/translate-article in a second client call.
